;;; Automatically created by pop-gen at 2012-05-01 10:38:49.
;;; Source file is UPDM-Profile-2012-05-01.xmi

(in-package :UPDM)



(def-meta-enum |ActualPropertySetKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Measurements-ActualPropertySetKind")
   (|Estimate| |Actual| |Required|)
   "Possible kinds of ActualMeasurementSet intention, derived from DoDAF.")



(def-meta-enum |ArchitectureFrameworkKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Views-ArchitectureFrameworkKind")
   (NAF |DoDAF| MODAF)
   "Enumeration of the possible types of architectural framework that the 
                       architecture is being developed for.")



(def-meta-enum |ClassificationType| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-DoDAF_Class_Library-ClassificationType")
   (S TS U C CTS CTS-B CTS-BALK CTSA NC NCA NR NS NS-A NS-S NSAT NU R)
   "Enumeration of types of security classification, derived from DoDAF.")



(def-meta-enum |DevelopmentStatus| (:model :UPDM :superclasses NIL 
...
(def-meta-enum |ExchangeElementKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Structure-ExchangeElementKind")
   (|InformationElement| |DataElement|)
   "Enumeration of the types of element being exchanged on an information 
                       exchange.")



(def-meta-enum |GeoPoliticalExtentKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Environment-GeoPoliticalExtentKind")
   (|Installation| |Other| |GeoFeature| |RegionOfCountry| |Country| |RegionOfWorld| |Facility| |Site|)
   "Enumeration of geopolitical extent kinds, used to support the         
               geoPoliticalExtentKind tag of the geoPoliticalExtent stereotype,
    derived from                     DoDAF.")



(def-meta-enum |GeoPoliticalExtentTypeKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Environment-GeoPoliticalExtentTypeKind")
   (|InstallationType| |OtherType| |GeoFeatureType| |RegionOfCountryType| |CountryType| |RegionOfWorldType| |FacilityType| |SiteType|)
   "Enumeration of kinds of geopolitical extent type, derived from DoDAF, used
                        to support the geoPoliticalExtentTypeKind tag of the
    GeopoliticalExtentType                     stereotype..")



(def-meta-enum |InformationKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-InformationKind")
   (|PositionReferenceFrame| |PedigreeInformation| |Data| |Information| |DomainInformation|)
   "Enumeration of kinds of information, derived from MODAF and DoDAF, used
    to                   support the InformationKind tag of the Information
    stereotype.")



(def-meta-enum |LocationKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Environment-LocationKind")
   (|PolygonArea| |RectangularArea| |ElipticalArea| |CircularArea| |Other| |SolidVolume| |Surface| |Line| |Point| |GeoStationaryPoint| |PlanarSurface|)
   "Enumeration of location kinds, derived from DoDAF, used to support the
                        locationKind tag of the LocationKind stereotype.")



(def-meta-enum |LocationTypeKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Environment-LocationTypeKind")
   (|PolygonAreaType| |RectangularAreaType| |ElipticalAreaType| |CircularAreaType| |OtherType| |SolidVolumeType| |SurfaceType| |LineType| |PointType| |GeoStationaryPointType| |PlanarSurfaceType|)
...
(def-meta-enum |MODAFRoleKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Structure-MODAFRoleKind")
   ...
   "Enumeration of the roles that a ResourceRole may play in the context of
    a                     CapabilityConfiguration or System, derived from MODAF,
    used to support the                     MODAFRoleKind tag of a ResourceRole")



(def-meta-enum |OperationalExchangeKind| (:model :UPDM :superclasses NIL 
...
(def-meta-enum |RuleKind| (:model :UPDM :superclasses NIL 
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Structure-RuleKind")
   (|SecurityPolicy| |StructuralAssertion| |ActionAssertion| |Derivation| |Agreement| |Constraint| |Guidance|)
...
;;; ====================== Activity
;;; =========================================================
;;; Activity specializes Desirer which specializes UPDMElement (Fig 8.177)
;;; Thus Activity should not directly specialize UPDMElement (Fig 8.11)
(def-meta-stereotype |Activity| 
   (:model :UPDM :superclasses (|Desirer| #| pod |UPDMElement| |#) :extends NIL
 ...
 "UPDM: An abstract element that represents a behavior (i.e. a Function or
                      OperationalActivity) that can be performed by a Performer.
  MODAF: NA DoDAF:                     Work, not specific to a single organization,
  weapon system or individual that                     transforms inputs
...
(def-meta-stereotype |ActivityPartOfCapability| 
   (:model :UPDM :superclasses (|MapsToCapability|) :extends (UML23:|Dependency|)
 ...
 "UPDM: As in DoDAF DoDAF: A disposition to manifest an Activity. An Activity
  to                   be performed to achieve a desired effect under specified
...
(def-meta-stereotype |ActivityPartOfProject| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Dependency|)
...
(def-meta-stereotype |ActivityPerformedByPerformer| 
   (:model :UPDM :superclasses (|IsCapableOfPerforming|) :extends (UML23:|Dependency|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Behavior-ActivityPerformedByPerformer")
 "UPDM: Links a Performer to the behavior that it can perform MODAF: NA 
                     DoDAF:An overlap of an Activity with a Resource, in
  particular a consuming or                     producing Activity that expresses
  an input, output, consumption, or production                     Activity
  of the Resourcee"
  ())
...
(def-meta-stereotype |ActualLocation| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|InstanceSpecification|)
 ...
 "MODAF: A PhysicalLocation (MODAF::ActualLocation) is a location anywhere
  on                     the earth. The means of describing the location
  is a string                     (locationDescription). The information
  contained in that string is governed by                     the taxonomy
  reference - e.g. if the PhysicalLocation is a \"GPS reference\", the    
                  string will contain the GPS coordinates. NOTE: this has
  been extended in UPDM to                     include non-earth locations.
  DoDAF: All subtypes of <<                     IndividualType>> Location,
  such as Facility, Site, etc."
  ((|address| :range |String| :multiplicity (1 1)
    :documentation
     "String describing the address of the actual location, i.e. \"1600      
                      Pennsylvania avenue\" describes the address of the actual
      location \"The White                       House\"")
   (|customKind| :range |String| :multiplicity (1 1)
    :documentation
     "String describing a location kind that is not on the enumerated list")
   (|locationKind| :range |LocationKind| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ActualMeasurement| 
   (:model :UPDM :superclasses (|ActualProperty|) :extends (UML23:|Slot|)
...
(def-meta-stereotype |ActualOrganization| 
   (:model :UPDM :superclasses (|ActualOrganizationalResource|) :extends (UML23:|InstanceSpecification|)
 ...
 "MODAF: An actual specific organisation, an instance of an organisation
                          class - e.g. \"The US Department of Defense\" DoDAF:
  [DoDAF::Organization]: A                         specific real-world assemblage
  of people and other resources organized for                         an
  on-going purpose."
  ((|code/symbol| :range |String| :multiplicity (1 1)
    :documentation
   ...
   (|serviceType| :range |String| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ActualOrganizationRelationship| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|InformationFlow|)
 ...
 "UPDM: A relationship between two ActualOrganizationResources. MODAF: A
                          relationship between two actual specific organisations
  or parts of an                         organisation. DoDAF: NA"
  ())
...
(def-meta-stereotype |ActualOrganizationRole| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Slot|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Organizational-Actual-ActualOrganizationRole")
 "UPDM: Relates an actual specific organization to an actual specific   
                       organizational resource that fulfils a role in that
  organization. MODAF: NA                         DoDAF: NA"
  ())
...
(def-meta-stereotype |ActualOrganizationalResource| 
   (:model :UPDM :superclasses (|CompetenceProvider| |LocationHolder|) :extends NIL
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Organizational-Actual-ActualOrganizationalResource")
 "UPDM: An ActualOrganization or an ActualPost. MODAF: An instance of   
                       either an actual organisation or an actual post. DoDAF:
  A specific                         real-world assemblage of people and
  other resources organized for an                         on-going purpose."
  ())
...
(def-meta-stereotype |ActualPerson| 
   (:model :UPDM :superclasses (|LocationHolder| |CompetenceProvider|) :extends (UML23:|InstanceSpecification|)
 ...
 "UPDM: Named individual that fulfills an ActualPost. An individual human
                          being (vs Person which is a type), that is recognized
  by law as the subject                         of rights and duties. MODAF:
  NA DoDAF: An individual person"
  ())
...
(def-meta-stereotype |ActualPost| 
 ...
 "UPDM: An actual, specific post, an instance of a PostType class - e.g.
                          \"President of the United States of America.\" MODAF:
  NA DoDAF: NA"
  ())
...
(def-meta-stereotype |ActualProject| 
 ...
 "MODAF: (MODAF::Project): A time-limited endeavour to create a specific
  set                     of products or services. DoDAF: (DoDAF::Project):
  A temporary endeavor                     undertaken to create Resources
  or Desired Effects."
  ((|endDate| :range |ISO8601DateTime| :multiplicity (0 1)
    :documentation
     "End time for this Project.")
   (|ownedMilestones| :range |ActualProjectMilestone| :multiplicity (1 -1) :is-derived-p T
    :documentation
     "Milestones associates with this project.")
   (|part| :range |ActualProject| :multiplicity (0 -1)
    :documentation
     "Sub-projects.")
   (|startDate| :range |ISO8601DateTime| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ActualProjectMilestone| 
 ...
 "MODAF: (ProjectMilestone): An event in a ActualProject (MODAF::Project)
  by                     which progress is measured. Note: in the case of
  an acquisition project, there                     are two key types of
  milestones which shall be represented using subtypes -                
      IncrementMilestone (MODAF::CapabilityIncrement) and OutOfServiceMilestone
...
(def-meta-stereotype |ActualProjectMilestoneRole| 
 ...
 "UPDM: An instance of a ProjectMilestoneRole in the context of an      
                ActualProject."
  ())
...
(def-meta-stereotype |ActualProperty| 
 ...
 "UPDM:The value of a Measure. MODAF:NA DoDAF:NA"
  ((|endDate| :range |ISO8601DateTime| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ActualPropertySet| 
 ...
 "UPDM: A set or collection of ActualMeasurement(s). A date of measurement
  can                     be set. An intent of ActualMeasurementSet can be
  \"Result\", \"Required\", or                     \"Estimate\" MODAF: NA DoDAF:
  NA"
  ((|appliesTo| :range |UPDMElement| :multiplicity (1 1)
    :documentation
     "Measured element.")))
...
(def-meta-stereotype |Alias| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Comment|)
...
(def-meta-stereotype |ArbitraryConnector| 
 ...
 "UPDM: Represents a visual indication of a connection used in high level
                      operational concept diagrams. The connections are purely
  visual and cannot be                     related to any architectural semantics.
  MODAF: NA DoDAF:NA"
  ())
...
(def-meta-stereotype |ArchitecturalDescription| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Package|)
 ...
 "MODAF: A specification of a system of systems at a technical level which
                      also provides the business context for the system of
  systems. DoDAF: Information                     describing an architecture
  such as an OV-5 Activity Model document."
  ((|approvalAuthority| :range |String| :multiplicity (0 -1)
   ...
   (|architect| :range |String| :multiplicity (1 1)
    :documentation
   ...
   (|assumptionAndConstraint| :range |String| :multiplicity (1 1)
    :documentation
     "Any assumptions, constraints, and limitations contained in the        
                    ArchitecturalDescription, including those affecting deployment,
      communications                       performance, information assurance
      environments, etc.")
   (|creatingOrganization| :range |String| :multiplicity (1 1)
    :documentation
     "Describes the ActualOrganizationalResource creating the               
             ArchitecturalDescription.")
   ...
   (|purpose| :range |String| :multiplicity (1 1)
    :documentation
     "Explains the need for the Architecture, what it will demonstrate, the 
                           types of analyses that will be applied to it, who
      is expected to perform the                       analyses, what decisions
      are expected to be made on the basis of each form of                  
          analysis, who is expected to make those decisions, and what actions
      are                       expected to result.")
   (|recommendations| :range |String| :multiplicity (1 1)
    :documentation
     "States the recommendations that have been developed based on the      
                      architecture effort. Examples include recommended system
      implementations, and                       opportunities for technology
      insertion.")
   (|summaryOfFindings| :range |String| :multiplicity (1 1)
    :documentation
     "Summarizes the findings that have been developed so far. This may be  
                          updated several times during the development of the
      ArchitecturalDescription.")
   (|toBe| :range |Boolean| :multiplicity (1 1)
    :documentation
     "Indicates whether the ArchitecturalDescription is existing or future.")
   (|toolsUsed| :range |String| :multiplicity (1 1)
    :documentation
     "Identifies any tools used to develop the ArchitecturalDescription as well
                            as file names and formats if appropriate.")
   (|viewpoint| :range |String| :multiplicity (1 1)
    :documentation
     "Indicates which viewpoints are used in the architecture.")
   (|views| :range |View| :multiplicity (1 -1)
    :documentation
...
(def-meta-stereotype |ArchitectureMetadata| 
   (:model :UPDM :superclasses (|Metadata|) :extends (UML23:|Comment|)
 ...
 "UPDM: Information on ArchitecturalDescription. It states things like what
                      methodology was used, notation, etc. MODAF: A Metadata
  element that applies to                     the whole architecture. DoDAF:
  NA"
  ())
...
(def-meta-stereotype |AssociationOfInformation| 
   (:model :UPDM :superclasses (|EntityRelationship|) :extends (UML23:|Association|)
 ...
 "MODAF: Asserts that there is a relationship between two entities (Entity
                      Relationship). DoDAF: A relationship or association
  between two elements of                     information."
  ())
...
(def-meta-stereotype |AsynchronousMessage| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Signal|)
...
(def-meta-stereotype |Capability| 
   (:model :UPDM :superclasses (|PropertySet| |Desirer|) :extends (UML23:|Class|)
 ...
 "MODAF: A high level specification of the enterprise's ability. DoDAF: The
  ...
  [performance] standards and                     conditions through combinations
  of ways and means [activities and resources] to                     perform
  a set of activities."
  ())
...
(def-meta-stereotype |CapabilityConfiguration| 
   (:model :UPDM :superclasses (|PhysicalArchitecture|) :extends (UML23:|Class|)
 ...
 "MODAF: A composite structure representing the physical and human resources
                      (and their interactions) in an enterprise.--A CapabilityConfiguration
  is a set                     of artefacts or an organisation configured
  to provide a capability, and should                     be guided by [doctrine]
  which may take the form of Standard or                     OperationalConstraint
  stereotypes. DoDAF: Any entity - human, automated, or any             
         aggregation of human and/or automated - that performs an activity
  and provides a                     capability (Performer)."
  ((|doctrine| :range UML23:|Constraint| :multiplicity (1 -1)
    :documentation
...
(def-meta-stereotype |CapabilityOfPerformer| 
   (:model :UPDM :superclasses (|Exhibits|) :extends (UML23:|Dependency|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-StrategicElements-CapabilityOfPerformer")
 "UPDM:A couple that represents the capability that a resource, node or 
                   enterprise phase exhibits (Exhibits). MODAF:An assertion
  that a Node is required                   to have a Capability (Capability
  for node). DoDAF: A couple that represents the                   capability
...
(def-meta-stereotype |CapableElement| 
 ...
 "UPDM An abstract element that represents a structural element that can
                      perform behaviors (i.e. PerformedActivity). DoDAF:
  NA"
  ())
...
(def-meta-stereotype |Climate| 
   (:model :UPDM :superclasses (|Environment|) :extends (UML23:|DataType|)
...
(def-meta-stereotype |Command| 
   (:model :UPDM :superclasses (|ResourceInteraction|) :extends (UML23:|InformationFlow|)
...
(def-meta-stereotype |Competence| 
   (:model :UPDM :superclasses (|SubjectOfForecast| |PropertySet|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Competence")
 "MODAF: A specific set of abilities defined by knowledge, skills and   
                   attitude. DoDAF: (DoDAF::Skill): The ability, coming from
...
(def-meta-stereotype |CompetenceProvider| 
 ...
 "UPDM:Abstract element used to group ActualPersons and                 
         ActualOrganisationalResources. MODAF:NA DoDAF:NA"
  ())
...
(def-meta-stereotype |CompetenceRequirer| 
 ...
 "UPDM:Abstract element used to group Organizations, Post and           
               Responsibilities. MODAF:NA DoDAF:NA"
  ())
...
(def-meta-stereotype |ConceptItem| 
 ...
 "UPDM: Abstract, an item which may feature in a high level operational 
                     concept. DoDAF:NA"
  ())
...
(def-meta-stereotype |ConceptRole| 
 ...
 "UPDM: Usage of a ConcepItem in the context of a HighLevelOperationalConcept
                      MODAF:-ItemInConcept, A relationship which asserts
  that a ConceptItem forms part                     of the high level operational
  concept DoDAF: N/AA"
  ())
...
(def-meta-stereotype |Condition| 
 ...
 "MODAF: A definition of the conditions in which something exists or    
                  functions. An Environment may be specified in terms of
  LocationType (e.g.                     terrain), Climate (e.g. tropical),
  and LightCondition (e.g. dark, light, dusk,                     etc.) DoDAF:
  An object that encompasses meteorological, geographic, and control    
                  features mission significance.."
  ((|conditionKind| :range |String| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ConditionProperty| 
   (:model :UPDM :superclasses (|EnvironmentProperty|) :extends (UML23:|Property|)
 ...
 "MODAF: EnvironmentalProperty: Asserts that an Environment has one or more
                      properties. These may be Climate, LocationType, or
  LightCondition. DoDAF: NA"
  ())
...
(def-meta-stereotype |Contract| 
   (:model :UPDM :superclasses NIL :extends (UML23:|InformationFlow|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-SOPES-Contract")
 "A specialization of an \"OperationalExchange\" a \"Contract\" specifies an
  agreement                 between two or more parties to exchange information.
  The Contract forms an                 ontological commitment between parties
  in a community of interest (CoI) or Community                 of Practice
  (CoP). The contract is also used to realize the information exchange  
                requirements of either a needline or a community of interest.est."
  ())
...
(def-meta-stereotype |Control| 
 ...
 "MODAF: A type of ResourceInteraction where one Resource (source) controls
                      another (target). --Examples - the driver of a tank,
  one organisation having                     operational control of another,
  a fire control system controlling a weapons                     system.
  DoDAF: NA"
  ())
...
(def-meta-stereotype |Definition| 
 ...
 "MODAF: A definition of an element in the architecture. DoDAF:NAA"
  ((|author| :range |String| :multiplicity (1 -1)
    :documentation
...
(def-meta-stereotype |DeployedMilestone| 
   (:model :UPDM :superclasses (|ActualProjectMilestone|) :extends (UML23:|InstanceSpecification|)
 ...
 "MODAF: Asserts that an ActualOrganisationResource started to use, or is
                      slated to start using a CapabilityConfiguration from
  a specific point in time.                     --This is used to describe
  capabilities going into service with specific                     organisations
  or posts. DoDAF: NA"
  ((|usedBy| :range |ActualOrganizationalResource| :multiplicity (1 -1)
    :documentation
...
(def-meta-stereotype |DesignRule| 
   (:model :UPDM :superclasses (|Rule|) :extends (UML23:|Constraint|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-SwAF-DesignRule")
 "A design rule is a solution to a problem in a specific context with the
                  following characteristics: -belongs to a problem domain,
  -packages knowledge in a                 reusable form, -standardize solutions
  to design problems within NBD, -gives value to                 the re-user."
...
(def-meta-stereotype |Desirer| 
 ...
 "UPDM:Abstract element used to group UPDM elements that might desire a 
                     particular effect."
  ())
...
(def-meta-stereotype |EnduringTask| 
   (:model :UPDM :superclasses (|Process|) :extends (UML23:|Activity|)
 ...
 "MODAF: A type of behaviour recognised by an enterprise as being essential
  to                     achieving its goals - i.e. a strategic specification
  of what the enterprise                     does. DoDAF: NA"
  ())
...
(def-meta-stereotype |Energy| 
   (:model :UPDM :superclasses (|OperationalExchangeItem| |ResourceInteractionItem|) :extends (UML23:|Class|)
 ...
 "UPDM: Energy to be exchanged between Nodes. MODAF: A unit of energy that
                      flows along an EnergyFLow or OperationalActivityEnergyFlow
  DoDAF: NA"
  ())
...
(def-meta-stereotype |EnterpriseGoal| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-StrategicElements-Structure-EnterpriseGoal")
 "MODAF: A specific, required objective of the enterprise that the      
                architecture represents. DoDAF: NAA"
  ((|benefits| :range |String| :multiplicity (0 -1) :is-ordered-p T
   ...
   (|enterprisePhase| :range |EnterprisePhase| :multiplicity (1 1)
...
(def-meta-stereotype |EnterprisePhase| 
   (:model :UPDM :superclasses (|CapableElement|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-StrategicElements-Structure-EnterprisePhase")
 "MODAF: A specific, required objective of the enterprise that the      
                architecture represents. DoDAF: NA"
  ((|desribedBy| :range |ArchitecturalDescription| :multiplicity (0 -1)
    :documentation
   ...
   (|vision| :range |EnterpriseVision| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |EnterpriseVision| 
   (:model :UPDM :superclasses (|Desirer|) :extends (UML23:|Class|)
 ...
 "MODAF: The overall aims of an enterprise over a given period of time. DoDAF:
                      (DoDAF::Vision): An end that describes the future state
  of the enterprise,                     without regard to how it is to be
  achieved; a mental image of what the future                     will or
  could be like."
  ((|enterprisePhase| :range |EnterprisePhase| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |EntityItem| 
   (:model :UPDM :superclasses (|SubjectOfResourceConstraint| |SubjectOfOperationalConstraint|) :extends (UML23:|Class|)
...
(def-meta-stereotype |EntityRelationship| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Association|)
 ...
 "MODAF: Asserts that there is a relationship between two EntityItems. DoDAF:
                      (DoDAF::DataAssociation): A relationship or association
  between two elements of                     proceduralized information."
  ())
...
(def-meta-stereotype |Environment| 
   (:model :UPDM :superclasses (|ConditionType| |PropertySet|) :extends (UML23:|DataType|)
...
;;; ====================== ExchangeElement
;;; =========================================================
;;; ExchangeElement specializes ResourceInteractionItem (Fig 8.29) which specializes Resource (Fig 8.127)
;;; which specializes SubjectOfResourceConstraint (Fig 8.141) 
;;; Thus ExchangeElement should not directly specialize SubjectOfResourceConstraint. (Fig 8.29)
(def-meta-stereotype |ExchangeElement| 
   (:model :UPDM :superclasses (|ResourceInteractionItem| 
				#| |SubjectOfResourceConstraint| POD |#
				|SubjectOfOperationalConstraint| 
				|OperationalExchangeItem|) 
	   :extends (UML23:|DataType|)
 ...
 "MODAF: A relationship specifying the need to exchange information between
                      nodes. DoDAF: NA - this is a specialization of OperationalExchange
                      (DoDAF::Interface)."
  ((|definedBy| :range |EntityItem| :multiplicity (0 -1) :is-derived-p T
    :documentation
     "The relationship between the EntityElement that defines the           
                 ExchangeElement.")
   (|exchangeElementKind| :range |ExchangeElementKind| :multiplicity (1 1) :is-derived-p T
    :documentation
...
(def-meta-stereotype |Exhibits| 
 ...
 "UPDM: Relationship between a Node and a capability the node provides. MODAF:
                      (MODAF::CapabilityForNode): An assertion that a Node
  is required to have a                     Capability. DoDAF: A couple that
  represents the capability that a performer                     manifests."
  ((|environmentalConditions| :range |Environment| :multiplicity (0 -1)
    :documentation
     "Asserts that a Capability's capabilityMetric (MeasureableProperty) is 
                           valid for a particular environment.")
   (|universalCapabilitySet| :range |ActualPropertySet| :multiplicity (0 1)
    :documentation
     "The ActualPropertySet that exists between a Capability and a Capable  
                          Element.")))
...
(def-meta-stereotype |ExternalIndividual| 
   (:model :UPDM :superclasses (|OntologyReference|) :extends (UML23:|InstanceSpecification|)
...
(def-meta-stereotype |ExternalTuple| 
   (:model :UPDM :superclasses (|OntologyReference|) :extends (UML23:|Class|)
...
(def-meta-stereotype |ExternalTupleType| 
   (:model :UPDM :superclasses (|ExternalType|) :extends (UML23:|Class|)
...
(def-meta-stereotype |FieldedCapability| 
 ...
 "MODAF: An actual, fully-realised capability. A FieldedCapability must 
                     indicate its configuration CapabilityConfiguration.
  DoDAF: NA"
  ())
...
(def-meta-stereotype |Function| 
   (:model :UPDM :superclasses (|SubjectOfResourceConstraint| |Activity|) :extends (UML23:|Activity|)
 ...
 "MODAF: An activity which is specified in context of the resource (human
  or                     machine) that performs it. DoDAF: Activity: Work,
  not specific to a single                     organization, weapon system
  or individual that transforms inputs (Resources)                     into
  outputs (Resources) or changes their state."
...
(def-meta-stereotype |FunctionAction| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|CallBehaviorAction|)
 ...
 "UPDM Artifact: The FunctionAction is defined as a call behavior action
  that                     invokes the function that needs to be performed.
  --This concept is required for                     mapping the architecture
...
(def-meta-stereotype |FunctionEdge| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|ActivityEdge|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Behavior-FunctionEdge")
 "UPDM: An extension of <<ActivityEdge>> that is                     used
  to model the flow of control/objects through a Function. MODAF: A     
                 FunctionEdge (MODAF::FunctionFlow) is a UML::ObjectFlow
  between Functions. NOTE:                     this has been extended in
...
(def-meta-stereotype |FunctionalStandard| 
   (:model :UPDM :superclasses (|Standard|) :extends (UML23:|Class|)
...
(def-meta-stereotype |GeoPoliticalExtent| 
 ...
 "UPDM: An instance of a GeoPoliticalExtentType MODAF:N/A DoDAF: N/A"
  ((|customKind| :range |String| :multiplicity (1 1)
   ...
   (|geoPoliticalExtentKind| :range |GeoPoliticalExtentKind| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |GeoPoliticalExtentType| 
   (:model :UPDM :superclasses (|ResourceInteractionItem| |OperationalExchangeItem| |ConditionType|) :extends (UML23:|DataType|)
 ...
 "MODAF:NA DoDAF:A geospatial extent whose boundaries are by declaration
  ...
  ((|customKind| :range |String| :multiplicity (1 1)
   ...
   (|geoPoliticalExtentTypeKind| :range |GeoPoliticalExtentTypeKind| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |ISO8601DateTime| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|LiteralString|)
 ...
 "MODAF: A date and time specified in the ISO8601 date-time format including
                    timezone designator (TZD): YYYY-MM-DDThh:mm:ssTZD. DoDAF:
  NA"
  ())
...
(def-meta-stereotype |Implements| 
   (:model :UPDM :superclasses NIL :extends (UML23:|Abstraction|)
 ...
 "UPDM:Tuple defining the relationship between systems and service elements
                      and operational elements MODAF: ActivityToFunctionMapping,
  Asserts that a                     Function (at least in part) performs
  or assists in the conducting of an                     OperationalActivity.
  DoDAF: N/A"
  ())
...
(def-meta-stereotype |IncrementMilestone| 
 ...
 "MODAF: (MODAF::CapabilityIncrement): An ActualProjectMilestone        
              (MODAF::ProjectMilestone) that indicates the point in time
  at which a project is                     predicted to deliver or has delivered
  a Capability. DoDAF: NA"
  ())
...
(def-meta-stereotype |IndividualPersonRole| 
   (:model :UPDM :superclasses (|ActualPost|) :extends (UML23:|InstanceSpecification|)
...
(def-meta-stereotype |Information| 
 ...
 "UPDM:As DoDAF MODAF:N/A DoDAF:Information is the state of a something of
                    interest that is materialized -- in any medium or form
...
(def-meta-stereotype |IsCapableOfPerforming| 
 ...
 "UPDM: Links a Performer to the behavior that it can perform. DoDAF: The
                      Performs (DoDAF::activityPerformedByPerformer) relationship
  is an overlap                     between a Performer and a PerformedActivity
  (DoDAF::Activity) wherein the                     activity is performed
  by the Performer."
  ())
...
(def-meta-stereotype |KnownResource| 
   (:model :UPDM :superclasses (|NodeRole|) :extends (UML23:|Property|)
 ...
 "MODAF: Asserts that a known Resource plays a part in the architecture.
                      DoDAF: NA     covered by the more general temporalWholePart
  element."
  ())
...
(def-meta-stereotype |Location| 
   (:model :UPDM :superclasses (|ActualLocation|) :extends (UML23:|InstanceSpecification|)
...
(def-meta-stereotype |LocationType| 
   (:model :UPDM :superclasses (|ConditionType| |ConceptItem|) :extends (UML23:|DataType|)
 ...
 "MODAF: A general specification of the surroundings / scenario in which
  an                     operation may take place. Examples would be: \"desert\",
  \"arctic\", \"at sea\", etc.                     DoDAF: A point or extent in
  space that may be referred to physically or                     logically.
  Includes concepts such as: Facility, Installation, RealProperty,      
                Site, , and instances of conditions such as underwater (as
  specified in UJTLs)."
  ((|customKind| :range |String| :multiplicity (1 1)
    :documentation
     "String defining custom kinds of locationTypes.")
   (|locationTypeKind| :range |LocationTypeKind| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |LogicalArchitecture| 
   (:model :UPDM :superclasses (|NodeParent|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-LogicalArchitecture")
 "MODAF: A CompositeStructureModel whose parts are either NodeRoles     
                 (MODAF::Node), ProblemDomains, or KnownResources. DoDAF:
  NA"
  ())
...
(def-meta-stereotype |LogicalDataModel| 
   (:model :UPDM :superclasses (|DataModel|) :extends (UML23:|Package|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Data-LogicalDataModel")
 "MODAF: A LogicalDataModel is a specification of business information  
                    requirements as a formal data structure, where relationships
  and classes                     (entities) are used to specify the logic
  which underpins the information. DoDAF:                     A Logical Data
  Model allows analysis of an architecture   s data definition          
            aspect, without consideration of implementation specific or product
  specific                     issues."
  ())
...
(def-meta-stereotype |MapsToCapability| 
 ...
 "MODAF: Asserts that a StandardOperationalActivity is in some way part of
  ...
  is a                     disposition to manifest an Activity. An Activity
  to be performed to achieve a                     desired effect under specified
  [performance] standards and conditions through                     combinations
  of ways and means."
  ())
...
(def-meta-stereotype |Materiel| 
   (:model :UPDM :superclasses (|ResourceInteractionItem|) :extends (UML23:|Class|)
 ...
 "MODAF: Artifact, A type of man-made object. Examples are \"car\", \"radio\",
                      \"diesel\", etc. DoDAF: Equipment, apparatus or supplies
  that are of interest,                     without distinction as to its
...
(def-meta-stereotype |Measure| 
   (:model :UPDM :superclasses (|ActualPropertySet|) :extends (UML23:|InstanceSpecification|)
...
(def-meta-stereotype |MeasureType| 
   (:model :UPDM :superclasses (|MeasurementSet|) :extends (UML23:|DataType|)
...
(def-meta-stereotype |Measurement| 
 ...
 "MODAF: MeasurableProperty: A property of something in the physical world,
                      expressed in amounts of a unit of measure. The property
  may have a required                     value - either specified by the
  [defaultValue] from UML::property attribute, or                     the
  [minValue] and [maxValue] to specify a required range. DoDAF: Measure:
  A                     Measurement (DoDAF::Measure) is the magnitude of
 ...
 "MODAF: Annotation that can be applied to any element in the architecture.
  ...
  ((|dublinCoreElement| :range |String| :multiplicity (0 1)
   ...
   (|modMetaDataElement| :range |String| :multiplicity (0 1)
    :documentation
     "If the meta data corresponds to the MOD Meta-Data Standard, then the  
                          meta-data element name should be listed here.")
...
(def-meta-stereotype |Mission| 
   (:model :UPDM :superclasses (|SubjectOfOperationalConstraint|) :extends (UML23:|Activity|)
 ...
 "MODAF: A purpose to which a person, organization or autonomous system is
                      tasked. DoDAF: The task, together with the purpose,
  that clearly indicates the                     action to be taken."
...
(def-meta-stereotype |Needline| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Connector|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Needline")
 "MODAF: A relationship between Nodes representing a bundle of          
            InformationExchanges. DoDAF: A needline documents the requirement
  to exchange                     information between nodes. The needline
  does not indicate how the information                     transfer is implemented.
  ."
  ())
...
(def-meta-stereotype |NoLongerUsedMilestone| 
 ...
 "MODAF: Asserts that an ActualOrganisationResource ceased to use or is slated
                      to cease using a CapabilityConfiguration from a specific
  point in time. --This                     is used to describe capabilities
  going out of service with specific                     organisations or
  posts. DoDAF:NA"
  ((|noLongerUsedBy| :range |ActualOrganizationalResource| :multiplicity (1 -1)
    :documentation
     "ActualOrganizationalResources that are no longer using                
            CapabilityConfiguration that went out of service at this Milestone.")))
...
(def-meta-stereotype |Node| 
   (:model :UPDM :superclasses (|SubjectOfOperationalStateMachine| |SubjectOfOperationalConstraint| |NodeParent| |ActivitySubject|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Node")
 "MODAF: A Node (MODAF::NodeType) is a logical entity that performs     
                 operational activities. Note: nodes are specified independently
  of any physical                     realization. DoDAF: A Node (DoDAF::OperationalNode)
  is an element of the                     operational architecture that
  produces, consumes, or processes information.                     NOTE:
  This is also a specialization of Performer. ."
...
(def-meta-stereotype |NodeOperation| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Operation|)
 ...
 "UPDM:A partial or full realization of an OperationalActivity. MODAF:NA
                      DoDAF:NA"
  ((|realizes| :range |OperationalActivity| :multiplicity (1 1)
...
(def-meta-stereotype |NodeParent| 
   (:model :UPDM :superclasses (|Participant|) :extends NIL
 ...
 "UPDM: An abstract element representing the owners/context of composite
                      structure at the operational level. MODAF:The abstract
  supertype of all elements                     that can have child Nodes
  (LogicalArchitecture, ProblemDomain &                     NodeType) DoDAF:NA"
  ())
...
(def-meta-stereotype |NodePort| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Port|)
 ...
 "UPDM: A port is a property of a Node that specifies a distinct interaction
                      point between the node and its environment or between
  the (behavior of the) node                     and its internal parts.
  It is the \"entry/exit\" point where resources (e.g.,                   
   energy, information/data and people, etc) flow in and out of a node."
  ())
...
(def-meta-stereotype |NodeRole| 
 ...
 "MODAF: A NodeRole (MODAF::Node) is used to link a parent Node to its  
                    sub-nodes. DoDAF: NA"
...
(def-meta-stereotype |OntologyReference| 
 ...
 "MODAF: A reference to an element in a recognized external ontology or 
                     taxonomy. DoDAF:NA"
...
(def-meta-stereotype |OperationalActivity| 
   (:model :UPDM :superclasses (|Process| |Activity| |SubjectOfOperationalConstraint|) :extends (UML23:|Activity|)
 ...
 "MODAF: A logical process, specified independently of how the process is
                      carried out.DoDAF: An activity is an action performed
  in conducting the business                     of an enterprise. It is
  a general term that does not imply a placement in a                   
   hierarchy (e.g., it could be a process or a task as defined in other documents
                      and it could be at any level of the hierarchy of the
  OV-5). It is used to                     portray operational actions not
  hardware/software system functions. NOTE: This                     is also
  a specialization of Activity. DoDAF:NANA"
...
(def-meta-stereotype |OperationalActivityAction| 
 ...
 "UPDM: The OperationalActivityAction is defined as a call behavior action
                      that invokes the activity that needs to be preformed.
  MODAF: Used to relate an                     OperationalActivity to its
  sub-activities. DoDAF:NAA"
  ())
...
(def-meta-stereotype |OperationalActivityEdge| 
 ...
 "UPDM An extension of <<ActivityEdge>> that is                     used
  to model the flow of control/objects through an OperationalActivity. MODAF:
                      An OperationalActivityEdge (MODAF::OperationalActivityFlow)
  is a flow of                     information, energy or materiel from one
  activity to another. DoDAF:NAA"
...
;;; =========================================================
;;; OperationalConstraint specializes Rule and UPDMElement (text under Generalization, section 8.3.1.3.3.4.14 wow)
;;; Rule specializes UPDMElement (Figure 8.32). 
(def-meta-stereotype |OperationalConstraint| 
   (:model :UPDM :superclasses (#| POD |UPDMElement||# |Rule|) :extends (UML23:|Constraint|)
 ...
 "UPDM: An abstract Class that is extended by OperationalConstraint (A rule
                      governing an operational behaviour or property.) and
  ResourceConstraint. MODAF:A                     rule governing an operational
  behaviour or property. DoDAF:A principle or                     condition
  that governs behavior; a prescribed guide for conduct or action       
               (Rule)."
  ())
...
(def-meta-stereotype |OperationalEventTrace| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Interaction|)
 ...
 "MODAF: An OperationalEventTrace (MODAF::OperationalInteractionSpecification)
                      is a specification of the interactions between nodes
  in an operational                     architecture. DoDAF: The Operational
  Event-Trace Description (OV-6c)                     DoDAF-described View
  provides a time ordered examination of the resource flows             
         as a result of a particular scenario. Each event-trace diagram will
  have an                     accompanying description that defines the particular
...
(def-meta-stereotype |OperationalExchange| 
   (:model :UPDM :superclasses (|SubjectOfOperationalConstraint| |Exchange|) :extends (UML23:|InformationFlow|)
 ...
 "UPDM: An utility element used as common flow for: - InformationExchange
  -                     OrganizationalExchange - EnergyExchange - MaterielExchange
  -                     ConfigurationExchange - GeoPoliticalExtent An operational
  exchange is formed                     when an activity of one operational
  node consumes items produced by another                     activity of
  a different operational node. An operational exchange describes the   
                   characteristics of the exchanged item, such as the content,
  format (voice,                     imagery, text and message format, etc.),
  throughput requirements, security or                     classification
  level, timeliness requirement, and the degree of                     interoperability.
  MODAF: An OperationalExchange (MODAF::LogicalFlow) asserts            
          that a flow exists or is required between Nodes (e.g. flows of
  information,                     people, materiel, or energy). eriel, or
  energy)."
  ((|exchangeKind| :range |OperationalExchangeKind| :multiplicity (1 1) :is-derived-p T
    :documentation
...
(def-meta-stereotype |OperationalExchangeItem| 
   (:model :UPDM :superclasses (|ActivitySubject| |Resource|) :extends NIL
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Flows-OperationalExchangeItem")
 "UPDM An abstract utility element used as common ancestor for: -       
               InformationElement - ResourceArtifact - Energy - OrganizationalResource
  -                     CapabilityConfiguration - GeoPoliticalExtentt"
  ())
...
(def-meta-stereotype |OperationalMessage| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Message|)
 ...
 "UPDM: Message for use in an Operational Event-Trace which carries any of
  the                     subtypes of OperationalExchange. This is used to
  provide additional information                     about OperationalMessages
  for display on an OV-6c.."
  ((|carries| :range |OperationalExchange| :multiplicity (0 -1) :is-derived-p T
    :documentation
     "Carried OperationalExchange.")
   (|operation| :range |NodeOperation| :multiplicity (1 1) :is-derived-p T
    :documentation
...
(def-meta-stereotype |OperationalParameter| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Parameter|)
...
(def-meta-stereotype |OperationalState| 
   (:model :UPDM :superclasses (|DesiredState|) :extends (UML23:|State|)
...
(def-meta-stereotype |OperationalStateDescription| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|StateMachine|)
 ...
 "UPDM: A state machine describing an operational behavior or property. MODAF:
                      An OperationalStateMachine (MODAF::OperationalStateDescription)
  is a rule                     governing an operational behavior or property.
  DoDAF: The Operational State                     Transition Description
  (OV-6b) DoDAF-described View is a graphical method of                 
     describing how an Operational Activity responds to various events by
  changing                     its state. The diagram represents the sets
  of events to which the Architecture                     will respond (by
  taking an action to move to a new state) as a function of its         
...
(def-meta-stereotype |Organization| 
   (:model :UPDM :superclasses (|OrganizationalResource|) :extends (UML23:|Class|)
...
(def-meta-stereotype |OrganizationType| 
   (:model :UPDM :superclasses (|Organization|) :extends (UML23:|Class|)
...
(def-meta-stereotype |OrganizationalResource| 
   (:model :UPDM :superclasses (|PhysicalResource|) :extends NIL
...
(def-meta-stereotype |OutOfServiceMilestone| 
 ...
 "MODAF: An OutOfServiceMilestone (MODAF::OutOfService) is a ProjectMilestone
                      that indicates a project's deliverable is to go out
  of service. DoDAF: NA"
  ())
...
(def-meta-stereotype |Participant| 
   (:model :UPDM :superclasses (|CapableElement| |OperationalExchangeItem| |Desirer| |ConceptItem|) :extends NIL
 ...
 "UPDM: A participant is the abstract type of a provider and/or consumer
  of                     services. In the business domain a participant may
  be a person, organization or                     system. In the systems
  domain a participant may be a system, application or                  
    component."
  ())
...
(def-meta-stereotype |Performer| 
   (:model :UPDM :superclasses (|Node|) :extends (UML23:|Class|)
 ...
 "MODAF:NA DoDAF:Any entity - human, automated, or any aggregation of human
                      and/or automated - that performs an activity and provides
  a capability. An alias                     for Node in DoDAF."
  ())
...
(def-meta-stereotype |Person| 
 ...
 "UPDM: A type of a human being that is recognized by law as the subject
                          of rights and duties. This is used to define the
  characteristics that                         require capturing for ActualPersons
  (e.g. properties such as address, rank,                         telephone
...
(def-meta-stereotype |PersonType| 
   (:model :UPDM :superclasses (|Post|) :extends (UML23:|Class|)
 ...
 "DoDAF:A category of persons defined by the role or roles they share that
                        are relevant to an architecture. Includes assigned
  materiel. MODAF:NANA"
  ())
...
(def-meta-stereotype |PhysicalArchitecture| 
   (:model :UPDM :superclasses (|SystemResource|) :extends (UML23:|Class|)
...
(def-meta-stereotype |PhysicalDataModel| 
 ...
 "MODAF: A PhysicalDataModel is an implementable specification of a data
                      structure. A PhysicalDataModel realises a LogicalDataModel,
  taking into account                     implementation restrictions and
  performance issues whilst still enforcing the                     constraints,
  relationships and typing of the logical model. DoDAF: A Physical      
                Data Model defines the structure of the various kinds of
  system or service data                     that are utilized by the systems
  or services in the Architecture.."
  ())
...
(def-meta-stereotype |PhysicalResource| 
 ...
 "UPDM: Abstract supertype for physical resources such as               
       OrganizationalResource. MODAF: A PhysicalAsset, OrganisationalResource
  or                     FunctionalResource that can contribute towards fulfilling
  a capability                     (MODAF::ResourceType)."
  ())
...
(def-meta-stereotype |Post| 
   (:model :UPDM :superclasses (|CompetenceRequirer| |OrganizationalResource|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Organizational-Typical-Post")
 "MODAF: A Post (MODAF::PostType) is a type of point of contact or      
                    responsible person. Note that this is the type of post
  - e.g. Desk Officer,                         Commander Land Component,
  etc. DoDAF: A Post (DoDAF:: PersonType) is a                         category
  of persons defined by the role or roles they share that are           
...
(def-meta-stereotype |ProblemDomain| 
 ...
 "MODAF: The boundary containing those Nodes which may be realised by   
                   functional resources specified in SV-1. There may be more
  than one alternative                     solution for a given ProblemDomain
  specified as a set of SV suites. There may be                     only
  one ProblemDomain in a LogicalArchitecture. DoDAF: NA     covered by the
  more                     general temporalWholePart element."
  ())
...
(def-meta-stereotype |Process| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Activity|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-OperationalElements-Behavior-Process")
 "MODAF:The abstract supertype of OperationalActivity and EnduringTask. 
                     DoDAF:NA"
  ())
...
(def-meta-stereotype |Project| 
   (:model :UPDM :superclasses (|ActualProject|) :extends (UML23:|InstanceSpecification|)
...
(def-meta-stereotype |ProjectActivity| 
   (:model :UPDM :superclasses (|Activity|) :extends (UML23:|Activity|)
...
(def-meta-stereotype |ProjectMilestone| 
 ...
 "UPDM: An element representing a collection of themes (e.g. DLOD or DOTMLPF)
                      which is connected to a Project as part of a Project
    s definition. This is used                     as a template for ActualProjectMilestones.
  MODAF: An event in a Project by which                     progress is measured.."
  ())
...
(def-meta-stereotype |ProjectMilestoneRole| 
 ...
 "UPDM: The role played by a ProjectMilestone in the context of an      
                ActualProjectMilestone MODAF: NA DoDAF: NA"
  ())
...
(def-meta-stereotype |ProjectOwnership| 
   (:model :UPDM :superclasses (|OrganizationalProjectRelationship|) :extends (UML23:|Dependency|)
...
(def-meta-stereotype |ProjectSequence| 
 ...
 "MODAF: Asserts that one ActualProject (MODAF::Project) follows from another
                      - i.e. the target ActualProject cannot start until
  the source ActualProject has                     ended. DoDAF: NA"
  ())
...
(def-meta-stereotype |ProjectStatus| 
 ...
 "MODAF: A ProjectStatus (MODAF::StatusAtMilestone) is a relationship between
                      a Status and a milestone that asserts the status (i.e.
  level of progress) of a                     ProjectTheme for the project
  at the time of the ActualProjectMilestone                     (MODAF::Milestone).
  DoDAF: NA"
  ())
...
(def-meta-stereotype |ProjectTheme| 
 ...
 "MODAF:An aspect by which the progress of various Projects may be measured.
                      In UK MOD, this could be one of the defence lines of
  development (DLOD), or                     DOTMLPF in the US. DoDAF: NA"
  ())
...
(def-meta-stereotype |ProjectType| 
   (:model :UPDM :superclasses (|Desirer| |UPDMElement|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AcquisitionElements-Milestone-ProjectType")
 "MODAF: A Project (MODAF::ProjectType) is used to define a category of 
                     project: For example, \"Programme\", \"Acquisition Project\"
  or \"Training                     Programme\". DoDAF: NA (only Individual
  Project in DoDAF)."
  ())
...
(def-meta-stereotype |Property| 
 ...
 "UPDM: The defining feature of an actual property, used to capture     
                 measurements MODAF: NA DoDAF: NA"
...
(def-meta-stereotype |ProtocolImplementation| 
 ...
 "UPDM: Abstract element: A connector that implements a specific Protocol.
  ...
  ((|implements| :range |Protocol| :multiplicity (1 1)
    :documentation
     "The <<Protocol>> which can be implemented by                     the Connector
      targets.")))
...
(def-meta-stereotype |ProvidesCompetence| 
 ...
 "UPDM: Asserts that a Resource type provides a competence. MODAF: Asserts
                          that a Role requires a Competence (MODAF::CompetenceForRole).
  DoDAF: An                         overlap between a Personnel Type and
  the Skills it entails (DoDAF::                         skillPartOfPersonType)"
...
(def-meta-stereotype |Request| 
   (:model :UPDM :superclasses (|ServicePort|) :extends (UML23:|Port|)
 ...
 "UPDM:From SoaML A Request represents a feature of a Participant that is
  the                     consumption of a service by one participant provided
  by others using                     well-defined terms, conditions and
  interfaces. A Request designates ports that                     define
  the connection point through which a Participant meets its needs through
                      the consumption of services provided by others. MODAF:
  Similar to requires,                     Asserts that a Resource requires
  a Service to be provided in order to function                     correctly.
  DoDAF: Similar to ServicePort, A part of a Performer that specifics a 
                     distinct interaction point through which the Performer
  interacts with other                     Performers. This isolates dependencies
...
(def-meta-stereotype |RequiresCompetence| 
 ...
 "MODAF:: Asserts that an Role requires a Competence                    
      (MODAF::CompetenceForRole). DoDAF: An overlap between a Personnel Type
  and                         the Skills it entails (DoDAF:: SkillPartOfPersonType)."
...
(def-meta-stereotype |Resource| 
   (:model :UPDM :superclasses (|LocationHolder| |PropertySet| |SubjectOfResourceConstraint|) :extends NIL
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Structure-Resource")
 "UPDM: Abstract element placeholder to indicate that resources can be  
                    exchanged in Operational and Systems views. MODAF: NA
  DoDAF: Data, Information,                     Performers, Materiel, or
...
(def-meta-stereotype |ResourceArtifact| 
   (:model :UPDM :superclasses (|PhysicalResource|) :extends (UML23:|Class|)
 ...
 "UPDM: A combination of physical element, energy, and data that are combined
                      used to accomplish a task or function. MODAF: A type
  of man-made object.                     Examples are \"car\", \"radio\", \"fuel\",
  etc. (MODAF:: Artefact)."
  ())
...
(def-meta-stereotype |ResourceConnector| 
   (:model :UPDM :superclasses (|ProtocolImplementation|) :extends (UML23:|Connector|)
 ...
 "UPDM: A physical connection between two resources that implements protocols
                      through which the source resource can transmit items
  to the destination                     resource. MODAF: Asserts that a
  connection exists between two ports belonging to                     parts
  in a system composite structure model (MODAF::SystemPortConnector). DoDAF:
                      NA"
  ((|realizedExchange| :range |ResourceInteraction| :multiplicity (0 -1)
    :documentation
     "A list of ResourceInteractions (or specializations) that realized by the
                            ResourceInterface/ResourceConnector. This is derived
      by navigating from the                       ResourceInteraction to the
      ResourceInterfaces/ResourceConnectors using the                       inverse
      of the realization/realizingConnector roles..")
...
(def-meta-stereotype |ResourceConstraint| 
 ...
 "MODAF: A rule governing the structural or functional aspects of an    
                  implementation - this may also include constraints on OrganisationalResources
                      that are part of an implementation. DoDAF: The range
  of permissible states for                     an object (DoDAF::Constraint).."
  ())
...
(def-meta-stereotype |ResourceInteraction| 
   (:model :UPDM :superclasses (|SubjectOfResourceConstraint| |Exchange|) :extends (UML23:|InformationFlow|)
 ...
 "UPDM: ResourceInteraction represents data that is exchanged between the
                      resources MODAF: An assertion that two FunctionalResources
  interact. Examples :                     data exchange between systems,
  conversations between people, people using                     systems.
  DoDAF: NA"
  ())
...
(def-meta-stereotype |ResourceInteractionItem| 
   (:model :UPDM :superclasses (|Resource|) :extends NIL
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Flows-ResourceInteractionItem")
 "UPDM Abstract: Represents the item(s) exchanged between the resources 
                     through a ResourceInteraction. MODAF: Formalised representation
  of data which is                     managed by or exchanged between systems
  (MODAF::DataElement). DoDAF:                     Representation of information
  in a formalized manner suitable for communication,                    
  interpretation, or processing by humans or by automatic means (DoDAF::Data)."
...
(def-meta-stereotype |ResourceInterface| 
 ...
 "UPDM: ResourceInterface is a contractual agreement between two resources
                      that implement protocols through which the source resource
  to the destination                     resource. MODAF: NA DoDAF: An overlap
  between Performers for the purpose of                     producing a Resource
  that is consumed by the other (DoDAF:: Interface)."
...
(def-meta-stereotype |ResourceMessage| 
 ...
 "UPDM: Message for use in a Resource Event-Trace, implements a         
             ResourceInteraction. MODAF: A specification of the interactions
  between aspects                     of a Resources architecture (MODAF::ResourceInteractionSpecification).
  DoDAF: An                     overlap of an Activity with a Resource, in
  particular a consuming or producing                     Activity that expresses
  an input, output, consumption, or production Activity of              
        the Resource (DoDAF:: activityResourceOverlap). ."
  ((|carries| :range |ResourceInteraction| :multiplicity (0 -1) :is-derived-p T
    :documentation
     "Carried ResourceInteraction")
   (|operation| :range |ResourceOperation| :multiplicity (1 1) :is-derived-p T
    :documentation
...
(def-meta-stereotype |ResourceOperation| 
 ...
 "UPDM:A partial or full realization of Function. MODAF:NA DoDAF:NA"
  ((|realizes| :range |Function| :multiplicity (1 1)
...
(def-meta-stereotype |ResourceParameter| 
 ...
 "UPDM: Represents inputs and outputs of Function. It is typed by       
               ResourceInteractionItem."
  ())
...
(def-meta-stereotype |ResourcePort| 
   (:model :UPDM :superclasses (|ProtocolImplementation|) :extends (UML23:|Port|)
 ...
 "UPDM: Port is an interaction point for a resource through which it can
                      interact with the outside environment. MODAF: An interface
  (logical or physical)                     provided by a System. A SystemPort
  may implement a PortType though there is no                     requirement
  for SystemPorts to be typed (MODAF:: SystemPort). DoDAF: An           
           interface (logical or physical) provided by a System (DoDAF::Port).."
  ())
...
(def-meta-stereotype |ResourceRole| 
 ...
 "UPDM: abstract element."
  ((|MODAFRoleKind| :range |MODAFRoleKind| :multiplicity (1 1) :default :other
    :documentation
...
(def-meta-stereotype |ResourceState| 
 ...
 "UPDM: State identified in the context of an ResourceStateDescription. 
                     MODAF:N/A DoDAF:N/A"
  ())
...
(def-meta-stereotype |Responsibility| 
   (:model :UPDM :superclasses (|OrganizationalResource| |CompetenceRequirer|) :extends (UML23:|Class|)
...
(def-meta-stereotype |RoleType| 
   (:model :UPDM :superclasses (|Responsibility|) :extends (UML23:|Class|)
...
(def-meta-stereotype |Rule| 
 ...
 "MODAF: An abstract Class that is extended by OperationalConstraint (A rule
                      governing an operational behaviour or property.) and
  ResourceConstraint (A rule                     governing the structural
  or functional aspects of an implementation - this may                 
     also include constraints on OrganisationalResources that are part of
  an                     implementation). DoDAF: Rule: A principle or condition
  that governs behavior; a                     prescribed guide for conduct
  or action. Subtype: Constraint: The range of                     permissible
  states for an object."
  ((|ruleKind| :range |RuleKind| :multiplicity (1 1))))
...
(def-meta-stereotype |SecurityAttributesGroup| 
 ...
 "MODAF:NA DoDAF:The group of Information Security Marking attributes in
  which                     the use of attributes 'classification' and 'ownerProducer'
  is required. This                     group is to be contrasted with group
  'SecurityAttributesOptionGroup' in which                     use of those
...
(def-meta-stereotype |Semantic| 
   (:model :UPDM :superclasses NIL :extends (UML23:|DataType|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-SOPES-Semantic")
 "A specialization of \"InformationElement\" the enables the specification
  of a                 complete dataset, which is considered meaningful to
  a community, organization,                 system or application; meeting
  one or more of the information flow requirements                 specification
  for a needline. The semantic is defined by the community, needline or 
  ...
  ((|containedTransactionals| :range |Transactional| :multiplicity (0 -1)
    :documentation
     "Represents the relationship between a \"Transactional\" and its containing
                        \"Semantic\". Meaning that during aggregation process of
      data represented by the                   \"Transactional\" is gathered into
      the containing \"Semantic\". When all the data                   represented
      by the \"Transactionals\" is gathered - the data set is complete and    
                    ready for formatting and exchange.e.")
   (|identifier| :range |Transactional| :multiplicity (1 1)
    :documentation
     "The \"identifier\" identifies the subtended Class that holds Unique Identifier
                        or Key needed for the construction of the data set. This
      subtended class would                   contain, as a minimum, the base
      Global Unique Identifier (e.g., Database Key,                   foreign
      keys or unique identifier) that would differentiate which transactional
      or                   wrappers (information element instances) are included
      in the construction of the                   composite. (e.g., foreign
      key relationships) There exists one and only one                   \"identifier\"
      on each semantic or transactional diagram.m.")))
...
(def-meta-stereotype |SemanticAttribute| 
   (:model :UPDM :superclasses NIL :extends (UML23:|Property|)
 ...
 "Specialization of Entity Attribute that enables the relationship between
                  logical/Interim-Processing and Operational/Business naming
  conventions."
  ())
...
(def-meta-stereotype |Service| 
 ...
 "MODAF:A type of delivered functionality, specified independently of the
                      resources that provide it. DoDAF: mechanism to enable
  access to a set of one or                     more capabilities , where
  the access is provided using a prescribed interface                   
   and is exercised consistent with constraints and policies as specified
  by the                     service description. The mechanism is a Performer.
  The \"capabilities\" accessed                     are Resources -- Information,
...
(def-meta-stereotype |ServiceDescription| 
   (:model :UPDM :superclasses (|ArchitecturalDescription|) :extends (UML23:|Package|)
 ...
 "UPDM: Package containing the elements that describe a service, from DoDAF
  2.                   DoDAF:Information necessary to interact with the service
  in such terms as the                   service inputs, outputs, and associated
  semantics. The service description also                   conveys what
  is accomplished when the service is invoked and the conditions for    
                using the service."
  ())
...
(def-meta-stereotype |ServiceFeature| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Feature|)
...
(def-meta-stereotype |ServiceFunction| 
 ...
 "UPDM: A ServiceFunction describes the abstract behavior of            
          ServiceOperations, regardless of the actual implementation. MODAF:
  A type of                     activity describing the functionality of
  a service. DoDAF: Information necessary                     to interact
  with the service in such terms as the service inputs, outputs, and    
                  associated semantics. The service description also conveys
  what is accomplished                     when the service is invoked and
...
(def-meta-stereotype |ServiceFunctionAction| 
 ...
 "UPDM: A call behavior action that invokes the ServiceFunction that needs
  to                     be preformed. --This concept is required for mapping
  the architecture with UML                     and does not have a DoDAF
  or MoDAF equivalent."
  ())
...
(def-meta-stereotype |ServiceFunctionEdge| 
 ...
 "UPDM: An extension of <<ActivityEdge>> that is                     used
  to model the flow of control/objects through a ServiceFunction."
  ())
...
(def-meta-stereotype |ServiceInteraction| 
 ...
 "UPDM: Interaction for a service interface MODAF: A model representing how
  a                     set of Service classes interacts with one another
...
(def-meta-stereotype |ServiceInterface| 
   (:model :UPDM :superclasses (|PropertySet|) :extends (UML23:|Class|)
 ...
 "UPDM: A contractual agreement between two resources that implement protocols
                      through which the source service interacts to the destination
  resource. A                     physical connection between two resources
  that implements protocols through                     which the source
  resource can transmit items to the destination resource. MODAF:       
               The mechanism by which a Service communicates. DoDAF: An overlap
  between                     Performers for the purpose of producing a Resource
  that is consumed by the                     other. (DoDAF::Interface).
  SOAML: Defines the interface to a Service Point or                    
  Request Point and is the type of a role in a service contract."
  ())
...
(def-meta-stereotype |ServiceLevelValueSet| 
 ...
 "MODAF:A value specification for a set of ServiceAttributes indicating the
                      level to which a Resource delivers a Service, in a
  particular environment.                     DoDAF:NA"
  ((|resourceBoundary| :range |ServicePort| :multiplicity (1 1)
...
(def-meta-stereotype |ServiceMessage| 
 ...
 "UPDM: Message for use in a Service Interaction Specification, implements
  ...
  ((|carries| :range |Exchange| :multiplicity (0 -1) :is-derived-p T
    :documentation
     "Carried ResourceInteraction.")
   (|operation| :range |ServiceOperation| :multiplicity (1 1) :is-derived-p T)))
...
(def-meta-stereotype |ServiceMessageHandler| 
   (:model :UPDM :superclasses (|ServiceFeature|) :extends (UML23:|Reception|)
...
(def-meta-stereotype |ServiceOperation| 
   (:model :UPDM :superclasses (|ServiceFeature|) :extends (UML23:|Operation|)
 ...
 "UPDM: A ServiceOperation provides the access point for invoking the behavior
                      of a provided service. The ServiceOperations are defined
  on ServiceInterfaces                     and mirrored on the providing
  Resource to handle calls forwarded on by the                     interface.
  MODAF: a function or procedure which enables programmatic             
         communication with a Service via a ServiceInterface (MODAF::   
                   ServiceInterfaceOpration)."
...
(def-meta-stereotype |ServiceParameter| 
 ...
 "UPDM: Represents inputs and outputs of Service. It is typed by        
              ResourceInteractionItem. MODAF: A constant or variable passed
  into or out of a                     ServiceInterface as part of the execution
  of a ServiceInterfaceOperation                     (MODAF:: ServiceInterfaceParameter).
  DoDAF: NA"
  ())
...
(def-meta-stereotype |ServicePolicy| 
   (:model :UPDM :superclasses (|Rule| |UPDMElement|) :extends (UML23:|Constraint|)
 ...
 "UPDM: A constraint governing the consumers and providers of services MODAF:
                      A constraint governing one or more Services. DoDAF:
  Agreement: A consent among                     parties regarding the terms
  and conditions of activities that said parties                     participate
  in."
  ())
...
(def-meta-stereotype |ServicePort| 
 ...
 "MODAF:ServiceInterface,The mechanism by which a Service communicates. 
                     DoDAF:A part of a Performer that specifics a distinct
  interaction point through                     which the Performer interacts
  with other Performers. This isolates dependencies                     between
...
(def-meta-stereotype |Skill| 
   (:model :UPDM :superclasses (|Competence|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-OperationalElements-Structure-Organizational-Skill")
 "MODAF:A specific set of abilities defined by knowledge, skills and    
                    attitude (Competence). DoDAF:The ability, coming from
...
(def-meta-stereotype |SkillOfPersonType| 
   (:model :UPDM :superclasses (|ProvidesCompetence|) :extends (UML23:|Dependency|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-OperationalElements-Structure-Organizational-SkillOfPersonType")
 "UPDM:Alias for ProvidesCompetence, the tuple showing the skills and   
                     competencies required from a particular role or organization
  DoDAF:A type                       property between a PersonRoleType and
...
(def-meta-stereotype |Software| 
   (:model :UPDM :superclasses (|ResourceArtifact|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Structure-Software")
 "MODAF: An executable computer programme. DoDAF: Materiel: Equipment,  
                    apparatus or supplies that are of interest, without distinction
...
(def-meta-stereotype |Standard| 
   (:model :UPDM :superclasses (|SubjectOfForecast|) :extends (UML23:|Class|)
 ...
 "MODAF: A ratified and peer-reviewed specification that is used to guide
  or                   constrain the architecture. A Standard may be applied
  to any element in the                   architecture via the [constrainedItem]
  property of UML::Constraint. DoDAF: A                   formal agreement
  documenting generally accepted specifications or criteria for         
  ...
  ((|InformationTechnologyStandardCategory| :range |String| :multiplicity (0 -1)
    :documentation
     "The information technology standard category which the                
          <<Standard>> belongs to.")
   ...
   (|version| :range |String| :multiplicity (0 1)
    :documentation
     "Represents the revision number of the Standard - e.g. \"1.2.1\", \"v2\",  
                        \":2004\", etc.")))
...
(def-meta-stereotype |StandardConfiguration| 
 ...
 "MODAF: A UML::Comment that when attached to a CapabilityConfiguration 
                   indicates that it is a standard pattern for re-use in
  the architecture. DoDAF: NA"
  ())
...
(def-meta-stereotype |StandardOperationalActivity| 
   (:model :UPDM :superclasses (|OperationalActivity|) :extends (UML23:|Activity|)
 ...
 "MODAF: An OperationalActivity that is a standard procedure that is doctrinal
                      . Note: This is equivalent to what some defence organisations
  call JETLs. DoDAF:                     Work, not specific to a single organization,
  weapon system or individual, that                     transforms inputs
  into outputs or changes their state (DoDAF:: Activity)."
  ())
...
(def-meta-stereotype |StatusIndicators| 
   (:model :UPDM :superclasses (|UPDMElement|) :extends (UML23:|Enumeration|)
...
(def-meta-stereotype |StereotypeExtension| 
 ...
 "MODAF: Defines an additional stereotype used in the architecture which
  is                     not defined in this meta-model. The body attribute
  contains the name of the new                     stereotype. The extendedStereotype
  tagged value shall contain the name of the                     meta-model
  stereotype which is extended. The ontologyReference tagged value      
                shall be populated with a reference to the external ontology
...
(def-meta-stereotype |StructuralPart| 
 ...
 "UPDM: An EnterprisePhase can be sub-divided into structural and temporal
                      parts. StructuralPart describes the EnterprisePhase
  elements that describe the                     structure. MODAF: Asserts
  that one EnterprisePhase is a spatial part of another,                
      (MODAF::EnterpriseStructure) Note:- This is a topological structuring
                      relationship, hence the EnterprisePhase may be physically
  disjoint"
  ())
...
(def-meta-stereotype |SystemResource| 
   (:model :UPDM :superclasses (|SubjectOfForecast| |Participant| |ResourceInteractionItem| |OperationalExchangeItem|) :extends (UML23:|Class|)
...
(def-meta-stereotype |TechnicalStandard| 
 ...
 "MODAF:A ratified and peer-reviewed specification that is used to guide
  or                   constrain the architecture. A Standard may be applied
  to any element in the                   architecture via the [constrainedItem]
  property of UML::Constraint (Standard).                   DoDAF:Technical
  standards document specific technical methodologies and practices     
...
(def-meta-stereotype |TemporalPart| 
 ...
 "UPDM Artifact: An EnterprisePhase can be sub-divided into structural and
                      temporal parts. TemporalPart describes the EnterprisePhase
  elements that have a                     time based nature. MODAF: Asserts
  that one EnterprisePhase is a temporal part of                     another.
  Note: This means that both EnterprisePhases have the same spatial     
                 extent - i..e this is only a temporal structure (MODAF::
...
(def-meta-stereotype |Transactional| 
 ...
 "A specialization of \"InformationElement\" the enables the specification
  of                 reusable information building blocks, upon which multiple
  community semantics can be                 built. Transactionals describe
  the constructions plans for data sets realizable from                 the
  underlying information/data store. The transactional links the community
                  semantics to the structures and business rules information/data
  store.e."
  ((|containedTransactionals| :range |Transactional| :multiplicity (0 -1)
    :documentation
     "Represents the relationship between a \"Transactional\" and its containing
                        \"Transactional\". Meaning that during the data aggregation
      process of data                   represented by the \"Transactional\" is
      gathered into the containing                   \"Transactional\".\".")
   (|containedWrappers| :range |Wrapper| :multiplicity (1 -1)
    :documentation
     "Represents the relationship between a \"Wrapper\" and its containing    
                    \"Transactional\". Meaning that during the data aggregation
      process of data                   represented by the \"Wrapper\" is gathered
      into the containing \"Transactional\"..")
...
(def-meta-stereotype |Trustline| 
 ...
 "MODAF:Asserts that the trustingParty (either a Node or a KnownResource)
                      trusts the trustedParty to a given level (indicated
  by the level attribute).                     Note: No unit of measure is
  associated with the level - security architects                     muist
  define their own scale of trust levels for a given architecture or set
  of                     architectures. DoDAF:NAA"
  ((|level| :range |String| :multiplicity (1 1)
    :documentation
...
(def-meta-stereotype |UPDMElement| 
 ...
 "UPDM Artifact: Super type for many of the UPDM elements. It provides a
  means                   of extending UPDM elements in a common way. With
  links to the measurement set, it                   also allows quantitative
  metrics to be associated with structural and behavioral               
     elements."
  ((URL/URI\  :range |String| :multiplicity (1 1)
    :documentation
     "Unique identifier for the element.")
...
(def-meta-stereotype |VersionOfConfiguration| 
 ...
 "MODAF:Asserts that a CapabilityConfiguration is a version of a        
              WholeLifeConfiguration. DoDAF:NA"
  ())
...
(def-meta-stereotype |View| 
   (:model :UPDM :superclasses (|UPDMElement| SYSML12:|View|) :extends (UML23:|Package|)
 ...
 "MODAF:A specification of a way to present an aspect of the architecture.
                      Views are defined with one or more purposes in mind
  - e.g. showing the logical                     topology of the enterprise,
  describing a process model, defining a data model,                    
  etc. DoDAF:NA"
  ((|architecturalElements| :range |UPDMElement| :multiplicity (0 -1)
    :documentation
     "Architectural elements contained in the view.")
   (|coversPhase| :range |EnterprisePhase| :multiplicity (1 1)
    :documentation
     "The EnterprisePhase that is covered by a view.")
   (|description| :range |String| :multiplicity (1 1)
    :documentation
     "Description of the view.")
   (|viewpoints| :range |Viewpoint| :multiplicity (1 -1)
    :documentation
...
(def-meta-stereotype |Vision| 
   (:model :UPDM :superclasses (|EnterpriseVision|) :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-StrategicElements-Vision")
 "MODAF:The overall aims of an enterprise over a given period of time.  
                  (EnterpriseVision) DoDAF:An end that describes the future
  state of the enterprise,                   without regard to how it is
  to be achieved; a mental image of what the future will                
    or could be like."
  ())
...
(def-meta-stereotype |VisionStatement| 
 ...
 "MODAF: A high-level textual description of an EnterpriseVision. DoDAF:
  An                     end that describes the future state of the enterprise,
  without regard to how it                     is to be achieved; a mental
  image of what the future will or could be like                     (DODAF::Vision)."
  ())
...
(def-meta-stereotype |WholeLifeEnterprise| 
   (:model :UPDM :superclasses (|EnterprisePhase|) :extends (UML23:|Class|)
 ...
 "UPDM: A WholeLifeEnterprise is a purposeful endeavor of any size involving
                      people, organizations and supporting systems (including
  physical systems and/or                     processes). MODAF: An EnterprisePhase
  that represents the whole existance of an                     enterprise.
  DoDAF: NA"
  ())
...
(def-meta-stereotype |Wrapper| 
   (:model :UPDM :superclasses NIL :extends (UML23:|Class|)
   :xmi-id "UPDM-UPDM_L1-UPDM_L0-SOPES-Wrapper")
 "A specialization of \"EntityItem\" that links a Transactional to the logical
                  information/data model Elements (e.g., DB Table). Wrappers
  represent a single                 instance of \"EntityItem\" data."
  ())
...
(def-meta-package |AcquisitionElements| |DoDAF| :UPDM 
   (|ActivityPartOfProject|
    |Project|
    |ProjectActivity|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AcquisitionElements")

(def-meta-package |AcquisitionElements| MODAF :UPDM 
   (|Structure|
    |Milestones|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-AcquisitionElements")

(def-meta-package |AcquisitionElements| |Core| :UPDM 
   (|Milestone|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AcquisitionElements")

(def-meta-package |Actual| |Organizational| :UPDM 
   (|ActualOrganization|
    |CompetenceProvider|
    |ActualOrganizationRelationship|
    |ActualOrganizationalResource|
    ...
    |ActualPerson|
    |FillsPost|
    |ActualOrganizationRole|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Organizational-Actual")

(def-meta-package |AllElements| |DoDAF| :UPDM 
   (|Measurements|
    |Environment|
    |InformationKind|
    |Behavior|
    |Information|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements")

(def-meta-package |AllElements| MODAF :UPDM 
   (|Environment|
    |Ontology|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-AllElements")

(def-meta-package |AllElements| |Core| :UPDM 
   (|Exchange|
    |Structure|
    |Measurements|
    |Environment|
    |Views|
    |Behavior|
    |UPDMElement|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements")

(def-meta-package |Behavior| |AllElements| :UPDM 
   (|ActivityPerformedByPerformer|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Behavior")

(def-meta-package |Behavior| |OperationalElements| :UPDM 
   (|StandardOperationalActivity|
    |OwnsProcess|
    |Process|
    |ActivitySubject|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-OperationalElements-Behavior")

(def-meta-package |Behavior| |SystemsElements| :UPDM 
   (|ResourceStateMachine|
    |FunctionEdge|
    |Function|
    |ResourceEventTrace|
    ...
    |ResourceOperation|
    |FunctionAction|
    |ResourceMessage|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Behavior")

(def-meta-package |Behavior| |ServiceElements| :UPDM 
   (|ServiceFunction|
    |ServiceFunctionAction|
    |ServiceOperation|
    |ServiceMessageHandler|
    ...
    |ServiceMessage|
    |ServiceFeature|
    |ServiceStateMachine|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-ServiceElements-Behavior")
...
(def-meta-package |Behavior| |OperationalElements| :UPDM 
   (|NodeOperation|
    ...
    |OperationalActivity|
    |SubjectOfOperationalStateMachine|
    |OperationalActivityEdge|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Behavior")
...
(def-meta-package |Core| UPDM\ L0 :UPDM 
   (|TechnicalStandardsElements|
    ...
    |StrategicElements|
    |OperationalElements|
    |AllElements|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core")

(def-meta-package |Data| |TechnicalStandardsElements| :UPDM 
   (|AssociationOfInformation|
    |SecurityAttributesGroup|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-TechnicalStandardsElements-Data")

(def-meta-package |Data| |TechnicalStandardsElements| :UPDM 
   (|EntityRelationship|
    |EntityAttribute|
    |EntityItem|
    |Details|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-TechnicalStandardsElements-Data")

(def-meta-package |Data| |SystemsElements| :UPDM 
   (|DataModel|
    |PhysicalDataModel|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Data")

(def-meta-package |Data| |OperationalElements| :UPDM 
   (|LogicalDataModel|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Data")

(def-meta-package |DoDAF| UPDM\ L0 :UPDM 
   (|AcquisitionElements|
    |TechnicalStandardsElements|
    |AllElements|
    |SystemElements|
...
(def-meta-package |DoDAF Class Library| UPDM :UPDM 
   (|ClassificationType|) :xmi-id "UPDM-DoDAF_Class_Library")

(def-meta-package |Environment| |AllElements| :UPDM 
   (|Location|
    |Condition|
    |GeoPoliticalExtentType|
    ...
    |ConditionProperty|
    |GeoPoliticalExtent|
    |GeoPoliticalExtentKind|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Environment")
...
(def-meta-package |ExternalTypes| |Core| :UPDM 
   (|ISO8601DateTime|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-ExternalTypes")

(def-meta-package |Flows| |OperationalElements| :UPDM 
   (|Control|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-OperationalElements-Flows")

(def-meta-package |Flows| |SystemsElements| :UPDM 
   (|ResourceInteraction|
    |ResourceInteractionItem|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Flows")

(def-meta-package |Flows| |OperationalElements| :UPDM 
   (|OperationalExchangeKind|
    |OperationalExchange|
    |OperationalExchangeItem|
    |Command|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Flows")

(def-meta-package MODAF UPDM\ L0 :UPDM 
   (|AcquisitionElements|
    |AllElements|
    |OperationalElements|
    |StrategicElements|
    |TechnicalStandardsElements|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF")

(def-meta-package |Measurements| |AllElements| :UPDM 
   (|MeasureType|
    |Measure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-AllElements-Measurements")

(def-meta-package |Measurements| |AllElements| :UPDM 
   (|Measurement|
    |ActualPropertySet|
    |ActualPropertySetKind|
    |ActualMeasurement|
    |ActualProperty|
    |PropertySet|
    |Property|
    |MeasurementSet|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Measurements")

(def-meta-package |Milestone| |AcquisitionElements| :UPDM 
   (|OrganizationalProjectRelationship|
    |ActualProject|
    |ProjectMilestoneRole|
    |ActualProjectMilestoneRole|
    |ProjectType|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AcquisitionElements-Milestone")

(def-meta-package |Milestones| |AcquisitionElements| :UPDM 
   (|ProjectOwnership|
    |MilestoneSequence|
    |OutOfServiceMilestone|
    |ActualProjectMilestone|
    |ProjectMilestone|
    |IncrementMilestone|
    |ProjectSequence|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-AcquisitionElements-Milestones")

(def-meta-package |Milestones| |StrategicElements| :UPDM 
   (|NoLongerUsedMilestone|
    |DeployedMilestone|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-StrategicElements-Milestones")

(def-meta-package |Ontology| |AllElements| :UPDM 
   (|OntologyReference|
    |ExternalIndividual|
    |Definition|
    |Alias|
    ...
    |StereotypeExtension|
    |ExternalType|
    |ExternalTuple|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-AllElements-Ontology")

(def-meta-package |OperationalElements| |DoDAF| :UPDM 
   (|Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-OperationalElements")

(def-meta-package |OperationalElements| MODAF :UPDM 
   (|Structure|
    |Behavior|
    |Flows|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-OperationalElements")

(def-meta-package |OperationalElements| |Core| :UPDM 
   (|Behavior|
    |Flows|
    |Data|
    |Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements")

(def-meta-package |Organizational| |Structure| :UPDM 
   (|SkillOfPersonType|
    |Skill|
    |IndividualPersonRole|
    |PersonType|
...
(def-meta-package SOPES UPDM\ L0 :UPDM 
   (|Transactional|
    |Wrapper|
    |Semantic|
    |SemanticAttribute|
    |TransactionalAttribute|
    |WrapperAttribute|
    |Contract|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-SOPES")

(def-meta-package |ServiceElements| |DoDAF| :UPDM 
   (|ServiceAccess|
    |ServiceDescription|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-ServiceElements")

(def-meta-package |ServiceElements| |Core| :UPDM 
   (|Behavior|
    |Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-ServiceElements")

(def-meta-package |SoaML| NIL :UPDM 
   () :xmi-id NIL)

(def-meta-package |StandardProfileL2| NIL :UPDM 
   () :xmi-id NIL)

(def-meta-package |StrategicElements| |DoDAF| :UPDM 
   (|ActivityPartOfCapability|
    |CapabilityOfPerformer|
    |Vision|
    |DesiredEffect|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-StrategicElements")

(def-meta-package |StrategicElements| MODAF :UPDM 
   (|Milestones|
    |Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-StrategicElements")

(def-meta-package |StrategicElements| |Core| :UPDM 
   (|Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-StrategicElements")

(def-meta-package |Structure| |SystemElements| :UPDM 
   (|System|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-SystemElements-Structure")

(def-meta-package |Structure| |OperationalElements| :UPDM 
   (|Performer|
    |Organizational|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-OperationalElements-Structure")

(def-meta-package |Structure| |AcquisitionElements| :UPDM 
   (|ProjectTheme|
    |StatusIndicators|
    |ProjectStatus|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-AcquisitionElements-Structure")

(def-meta-package |Structure| |OperationalElements| :UPDM 
   (|Organizational|
    |Trustline|
    |ProblemDomain|
    |Energy|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-OperationalElements-Structure")

(def-meta-package |Structure| |StrategicElements| :UPDM 
   (|EnduringTask|
    |WholeLifeEnterprise|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-StrategicElements-Structure")

(def-meta-package |Structure| |SystemsElements| :UPDM 
   (|VersionOfConfiguration|
    |ResourceInterface|
    |SubjectOfResourceConstraint|
    |ResourceConstraint|
    ...
    |ResourceConnector|
    |ResourceRole|
    |SubjectOfForecast|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements-Structure")

(def-meta-package |Structure| |ServiceElements| :UPDM 
   (|ServiceAttribute|
    |ServiceLevelValue|
    |ServiceInterface|
    |Service|
...
(def-meta-package |Structure| |StrategicElements| :UPDM 
   (|StructuralPart|
    ...
    |VisionStatement|
    |DesiredState|
    |Desirer|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-StrategicElements-Structure")
...
(def-meta-package |Structure| |OperationalElements| :UPDM 
   (|NodeParent|
    ...
    |OperationalConstraint|
    |HighLevelOperationalConcept|
    |ConceptRole|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure")

(def-meta-package |Structure| |AllElements| :UPDM 
   (|Resource|
    |RuleKind|
    |Participant|
    |ExchangeElement|
...
(def-meta-package |SwAF| UPDM\ L0 :UPDM 
   (|DevelopmentStatus|
    |DesignRule|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-SwAF")

(def-meta-package |SysML| NIL :UPDM 
   () :xmi-id NIL)

(def-meta-package |SystemElements| |DoDAF| :UPDM 
   (|Structure|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-SystemElements")

(def-meta-package |SystemsElements| |Core| :UPDM 
   (|Structure|
    |Flows|
    |Data|
    |Behavior|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-SystemsElements")

(def-meta-package |TechnicalStandardsElements| |DoDAF| :UPDM 
   (|FunctionalStandard|
    |Data|
    |TechnicalStandard|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-DoDAF-TechnicalStandardsElements")

(def-meta-package |TechnicalStandardsElements| MODAF :UPDM 
   (|ProtocolLayer|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-MODAF-TechnicalStandardsElements")

(def-meta-package |TechnicalStandardsElements| |Core| :UPDM 
   (|Standard|
    |StandardConfiguration|
    |ProtocolImplementation|
    |Data|
...
(def-meta-package |Typical| |Organizational| :UPDM 
   (|Post|
    |RequiresCompetence|
    |Responsibility|
    |CompetenceRequirer|
    ...
    |OrganizationalResource|
    |Organization|
    |ProvidesCompetence|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-OperationalElements-Structure-Organizational-Typical")

(def-meta-package UML\ 2.3 NIL :UPDM 
   () :xmi-id NIL)

(def-meta-package UPDM NIL :UPDM 
   (UPDM\ L1
    |DoDAF Class Library|) :xmi-id "UPDM")

(def-meta-package UPDM\ L0 UPDM\ L1 :UPDM 
   (|SwAF|
    |DoDAF|
    MODAF
    |Core|
    SOPES) :xmi-id "UPDM-UPDM_L1-UPDM_L0")

(def-meta-package UPDM\ L1 UPDM :UPDM 
   (UPDM\ L0) :xmi-id "UPDM-UPDM_L1")

(def-meta-package |Views| |AllElements| :UPDM 
   (|View|
    |ArchitecturalReference|
    ...
    |Metadata|
    |ArchitecturalDescription|
    |ArchitectureMetadata|) :xmi-id "UPDM-UPDM_L1-UPDM_L0-Core-AllElements-Views")
...
(with-slots (mofi::abstract-classes mofi:ns-uri mofi:ns-prefix) mofi:*model*
     (setf mofi::abstract-classes 
        '(UPDM:|Activity|
          ...
          UPDM:|SystemResource|
          UPDM:|UPDMElement|))
     (setf mofi:ns-uri "http://www.omg.org/spec/UPDM/20120301")
