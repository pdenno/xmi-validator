;;; Automatically created by pop-gen at 2022-06-25 14:55:20.
;;; Source file is xmi-validator/data/uml251/ptc-18-01-03-std-profile.xmi

(in-package :UML-PROFILE-20161101)
...
(def-meta-stereotype |Auxiliary|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Class|)
 :packages (|StandardProfileL2|)
 :xmi-id "Auxiliary")
 ""
  ((|base_Class| :xmi-id "Auxiliary-base_Class"
...
(def-meta-stereotype |BuildComponent|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Component|)
 :packages (|StandardProfileL2|)
 :xmi-id "BuildComponent")
 ""
  ((|base_Component| :xmi-id "BuildComponent-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))

(def-meta-assoc "Component_BuildComponent"
  :name |Component_BuildComponent|
  :metatype :extension
  :member-ends (("Component_BuildComponent-extension_BuildComponent"
		 "extension_BuildComponent")
		(|BuildComponent| "base_Component"))
  :owned-ends  (("Component_BuildComponent-extension_BuildComponent"
		 "extension_BuildComponent")))
...
(def-meta-stereotype |Call|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Usage|)
 :packages (|StandardProfileL2|)
 :xmi-id "Call")
 ""
  ((|base_Usage| :xmi-id "Call-base_Usage"
    :range UML251:|Usage| :multiplicity (1 1))))
...
(def-meta-stereotype |Create|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|BehavioralFeature|
								UML251:|Usage|)
 :packages (|StandardProfileL2|)
 :xmi-id "Create")
 ""
  ((|base_BehavioralFeature| :xmi-id "Create-base_BehavioralFeature"
    :range UML251:|BehavioralFeature| :multiplicity (1 1))
   (|base_Usage| :xmi-id "Create-base_Usage"
    :range UML251:|Usage| :multiplicity (1 1))))
...
(def-meta-stereotype |Derive|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Abstraction|)
 :packages (|StandardProfileL2|)
 :xmi-id "Derive")
 ""
  ((|base_Abstraction| :xmi-id "Derive-base_Abstraction"
    :range UML251:|Abstraction| :multiplicity (1 1))))
...
(def-meta-stereotype |Destroy|
 ...
 :xmi-id "Destroy")
 ""
  ((|base_BehavioralFeature| :xmi-id "Destroy-base_BehavioralFeature"
    :range UML251:|BehavioralFeature| :multiplicity (1 1))))

(def-meta-assoc "BehavioralFeature_Destroy"
  :name |BehavioralFeature_Destroy|
  :metatype :extension
  :member-ends (("BehavioralFeature_Destroy-extension_Destroy"
		 "extension_Destroy")
		(|Destroy| "base_BehavioralFeature"))
  :owned-ends  (("BehavioralFeature_Destroy-extension_Destroy"
		 "extension_Destroy")))
...
(def-meta-stereotype |Document|
   (:model :UML-PROFILE-20161101 :superclasses (|File|) :extends (UML251:|Artifact|)
 :packages (|StandardProfileL2|)
 :xmi-id "Document")
 ""
  ((|base_Artifact| :xmi-id "Document-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))
...
(def-meta-stereotype |Entity|
 ...
 :xmi-id "Entity")
 ""
  ((|base_Component| :xmi-id "Entity-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))
...
(def-meta-stereotype |Executable|
 ...
 :xmi-id "Executable")
 ""
  ((|base_Artifact| :xmi-id "Executable-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))

(def-meta-assoc "Artifact_Executable"
  :name |Artifact_Executable|
  :metatype :extension
  :member-ends (("Artifact_Executable-extension_Executable"
		 "extension_Executable")
		(|Executable| "base_Artifact"))
  :owned-ends  (("Artifact_Executable-extension_Executable"
		 "extension_Executable")))
...
(def-meta-stereotype |File|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Artifact|)
 :packages (|StandardProfileL2|)
 :xmi-id "File")
 ""
  ((|base_Artifact| :xmi-id "File-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))
...
(def-meta-stereotype |Focus|
 ...
 :xmi-id "Focus")
 ""
  ((|base_Class| :xmi-id "Focus-base_Class"
    :range UML251:|Class| :multiplicity (1 1))))
...
(def-meta-stereotype |Framework|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Package|)
 :packages (|StandardProfileL2|)
 :xmi-id "Framework")
 ""
  ((|base_Package| :xmi-id "Framework-base_Package"
    :range UML251:|Package| :multiplicity (1 1))))
...
(def-meta-stereotype |Implement|
 ...
 :xmi-id "Implement")
 ""
  ((|base_Component| :xmi-id "Implement-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))

(def-meta-assoc "Component_Implement"
  :name |Component_Implement|
  :metatype :extension
  :member-ends (("Component_Implement-extension_Implement"
		 "extension_Implement")
		(|Implement| "base_Component"))
  :owned-ends  (("Component_Implement-extension_Implement"
		 "extension_Implement")))
...
(def-meta-stereotype |ImplementationClass|
 ...
 ""
  ((|base_Class| :xmi-id "ImplementationClass-base_Class"
    :range UML251:|Class| :multiplicity (1 1))))

(def-meta-assoc "Class_ImplementationClass"
  :name |Class_ImplementationClass|
  :metatype :extension
  :member-ends (("Class_ImplementationClass-extension_ImplementationClass"
		 "extension_ImplementationClass")
		(|ImplementationClass| "base_Class"))
  :owned-ends  (("Class_ImplementationClass-extension_ImplementationClass"
		 "extension_ImplementationClass")))
...
(def-meta-stereotype |Instantiate|
 ...
 :xmi-id "Instantiate")
 ""
  ((|base_Usage| :xmi-id "Instantiate-base_Usage"
    :range UML251:|Usage| :multiplicity (1 1))))

(def-meta-assoc "Usage_Instantiate"
  :name |Usage_Instantiate|
  :metatype :extension
  :member-ends (("Usage_Instantiate-extension_Instantiate"
		 "extension_Instantiate")
		(|Instantiate| "base_Usage"))
  :owned-ends  (("Usage_Instantiate-extension_Instantiate"
		 "extension_Instantiate")))
...
(def-meta-stereotype |Library|
 ...
 :xmi-id "Library")
 ""
  ((|base_Artifact| :xmi-id "Library-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))
...
(def-meta-stereotype |Metaclass|
 ...
 :xmi-id "Metaclass")
 ""
  ((|base_Class| :xmi-id "Metaclass-base_Class"
    :range UML251:|Class| :multiplicity (1 1))))
...
(def-meta-stereotype |Metamodel|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Model|)
 :packages (|StandardProfileL2|)
 :xmi-id "Metamodel")
 ""
  ((|base_Model| :xmi-id "Metamodel-base_Model"
    :range UML251:|Model| :multiplicity (1 1))))
...
(def-meta-stereotype |ModelLibrary|
 ...
 :xmi-id "ModelLibrary")
 ""
  ((|base_Package| :xmi-id "ModelLibrary-base_Package"
    :range UML251:|Package| :multiplicity (1 1))))

(def-meta-assoc "Package_ModelLibrary"
  :name |Package_ModelLibrary|
  :metatype :extension
  :member-ends (("Package_ModelLibrary-extension_ModelLibrary"
		 "extension_ModelLibrary")
		(|ModelLibrary| "base_Package"))
  :owned-ends  (("Package_ModelLibrary-extension_ModelLibrary"
		 "extension_ModelLibrary")))
...
(def-meta-stereotype |Process|
 ...
 :xmi-id "Process")
 ""
  ((|base_Component| :xmi-id "Process-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))
...
(def-meta-stereotype |Realization|
   (:model :UML-PROFILE-20161101 :superclasses NIL :extends (UML251:|Classifier|)
 :packages (|StandardProfileL2|)
 :xmi-id "Realization")
 ""
  ((|base_Classifier| :xmi-id "Realization-base_Classifier"
    :range UML251:|Classifier| :multiplicity (1 1))))

(def-meta-assoc "Classifier_Realization"
  :name |Classifier_Realization|
  :metatype :extension
  :member-ends (("Classifier_Realization-extension_Realization"
		 "extension_Realization")
		(|Realization| "base_Classifier"))
  :owned-ends  (("Classifier_Realization-extension_Realization"
		 "extension_Realization")))
...
(def-meta-stereotype |Refine|
 ...
 :xmi-id "Refine")
 ""
  ((|base_Abstraction| :xmi-id "Refine-base_Abstraction"
    :range UML251:|Abstraction| :multiplicity (1 1))))
...
(def-meta-stereotype |Responsibility|
 ...
 ""
  ((|base_Usage| :xmi-id "Responsibility-base_Usage"
    :range UML251:|Usage| :multiplicity (1 1))))

(def-meta-assoc "Usage_Responsibility"
  :name |Usage_Responsibility|
  :metatype :extension
  :member-ends (("Usage_Responsibility-extension_Responsibility"
		 "extension_Responsibility")
		(|Responsibility| "base_Usage"))
  :owned-ends  (("Usage_Responsibility-extension_Responsibility"
		 "extension_Responsibility")))
...
(def-meta-stereotype |Script|
 ...
 :xmi-id "Script")
 ""
  ((|base_Artifact| :xmi-id "Script-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))
...
(def-meta-stereotype |Send|
 ...
 :xmi-id "Send")
 ""
  ((|base_Usage| :xmi-id "Send-base_Usage"
    :range UML251:|Usage| :multiplicity (1 1))))
...
(def-meta-stereotype |Service|
 ...
 :xmi-id "Service")
 ""
  ((|base_Component| :xmi-id "Service-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))
...
(def-meta-stereotype |Source|
 ...
 :xmi-id "Source")
 ""
  ((|base_Artifact| :xmi-id "Source-base_Artifact"
    :range UML251:|Artifact| :multiplicity (1 1))))
...
(def-meta-stereotype |Specification|
 ...
 ""
  ((|base_Classifier| :xmi-id "Specification-base_Classifier"
    :range UML251:|Classifier| :multiplicity (1 1))))

(def-meta-assoc "Classifier_Specification"
  :name |Classifier_Specification|
  :metatype :extension
  :member-ends (("Classifier_Specification-extension_Specification"
		 "extension_Specification")
		(|Specification| "base_Classifier"))
  :owned-ends  (("Classifier_Specification-extension_Specification"
		 "extension_Specification")))
...
(def-meta-stereotype |Subsystem|
 ...
 :xmi-id "Subsystem")
 ""
  ((|base_Component| :xmi-id "Subsystem-base_Component"
    :range UML251:|Component| :multiplicity (1 1))))

(def-meta-assoc "Component_Subsystem"
  :name |Component_Subsystem|
  :metatype :extension
  :member-ends (("Component_Subsystem-extension_Subsystem"
		 "extension_Subsystem")
		(|Subsystem| "base_Component"))
  :owned-ends  (("Component_Subsystem-extension_Subsystem"
		 "extension_Subsystem")))
...
(def-meta-stereotype |SystemModel|
 ...
 :xmi-id "SystemModel")
 ""
  ((|base_Model| :xmi-id "SystemModel-base_Model"
    :range UML251:|Model| :multiplicity (1 1))))

(def-meta-assoc "Model_SystemModel"
  :name |Model_SystemModel|
  :metatype :extension
  :member-ends (("Model_SystemModel-extension_SystemModel"
		 "extension_SystemModel")
		(|SystemModel| "base_Model"))
  :owned-ends  (("Model_SystemModel-extension_SystemModel"
		 "extension_SystemModel")))
...
(def-meta-stereotype |Type|
 ...
 :xmi-id "Type")
 ""
  ((|base_Class| :xmi-id "Type-base_Class"
    :range UML251:|Class| :multiplicity (1 1))))
...
(def-meta-stereotype |Utility|
 ...
 :xmi-id "Utility")
 ""
  ((|base_Class| :xmi-id "Utility-base_Class"
    :range UML251:|Class| :multiplicity (1 1))))
...
(def-meta-package |StandardProfileL2| NIL :UML-PROFILE-20161101
   (|Auxiliary|
    |Call|
    |Create|
    |Derive|
    ...
    |BuildComponent|
    |Metamodel|
    |SystemModel|) :xmi-id "_0")

(def-meta-package |UML 2.5.1| NIL :UML-PROFILE-20161101
   () :xmi-id NIL)
...
(with-slots (abstract-classes ns-uri ns-prefix) *model*
	...
	'())
     (setf ns-uri "http://www.omg.org/spec/UML/20161101/StandardProfile")
     (setf ns-prefix "StandardProfile"))
