...
(def-meta-constraint |unmarshall_signal_events| |AcceptEventAction|
   "If isUnmarshall is true (and this is not an AcceptCallAction), there must
    ...
    corresponding attribute of the signal. The multiplicity of each result
 ...
 "An Activity is the specification of parameterized Behavior as the coordinated
  ...
  ((|edge| :xmi-id "Activity-edge"
   ...
   (|structuredNode| :xmi-id "Activity-structuredNode"
    :range |StructuredActivityNode| :multiplicity (0 -1) :is-composite-p T
...
(def-meta-class |ActivityEdge|
 ...
 "An ActivityEdge is an abstract class for directed connections between two
  ...
  ((|activity| :xmi-id "ActivityEdge-activity"
   ...
   (|inStructuredNode| :xmi-id "ActivityEdge-inStructuredNode"
...
(def-meta-constraint |represents_classifier| |ActivityPartition|
   "If a non-external ActivityPartition represents a Classifier and has a superPartition,
    ...
    in the Classifier represented by the superPartition, or be at the contained
...
(def-meta-class |Artifact|
 ...
 "An artifact is the specification of a physical piece of information that
  ...
  ((|fileName| :xmi-id "Artifact-fileName"
   ...
   (|manifestation| :xmi-id "Artifact-manifestation"
    ...
    :documentation
     "The set of model elements that are manifested in the Artifact. That is,
      ...
      the artifact.")
   (|nestedArtifact| :xmi-id "Artifact-nestedArtifact"
    :range |Artifact| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Namespace| |ownedMember|))
    :documentation
   ...
   (|ownedOperation| :xmi-id "Artifact-ownedOperation"
...
(def-meta-class |Association|
 ...
 "A link is a tuple of values that refer to typed objects.  An Association
  ...
  ((|endType| :xmi-id "Association-endType"
    :range |Type| :multiplicity (1 -1) :is-readonly-p T :is-derived-p T
...
(def-meta-class |Classifier|
 ...
 "A Classifier represents a classification of instances according to their
  ...
  ((|attribute| :xmi-id "Classifier-attribute"
    :range |Property| :multiplicity (0 -1) :is-derived-union-p T :is-readonly-p T :is-ordered-p T :is-derived-p T
   ...
   (|collaborationUse| :xmi-id "Classifier-collaborationUse"
    :range |CollaborationUse| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :documentation
   ...
   (|ownedTemplateSignature| :xmi-id "Classifier-ownedTemplateSignature"
    :range |RedefinableTemplateSignature| :multiplicity (0 1) :is-composite-p T
   ...
   (|representation| :xmi-id "Classifier-representation"
    :range |CollaborationUse| :multiplicity (0 1)
   ...
   (|templateParameter| :xmi-id "Classifier-templateParameter"
    :range |ClassifierTemplateParameter| :multiplicity (0 1)
...
(def-meta-class |ClassifierTemplateParameter|
 ...
 "A ClassifierTemplateParameter exposes a Classifier as a formal template
  parameter."
  ((|allowSubstitutable| :xmi-id "ClassifierTemplateParameter-allowSubstitutable"
    :range |Boolean| :multiplicity (1 1) :default :true
    :documentation
     "Constrains the required relationship between an actual parameter and the
      parameteredElement for this formal parameter.")
   (|constrainingClassifier| :xmi-id "ClassifierTemplateParameter-constrainingClassifier"
    :range |Classifier| :multiplicity (0 -1)
    :documentation
   ...
   (|parameteredElement| :xmi-id "ClassifierTemplateParameter-parameteredElement"
...
(def-meta-class |Clause|
 ...
 "A Clause is an Element that represents a single branch of a ConditionalNode,
  ...
  ((|body| :xmi-id "Clause-body"
   ...
   (|bodyOutput| :xmi-id "Clause-bodyOutput"
    :range |OutputPin| :multiplicity (0 -1) :is-ordered-p T
    :documentation
...
(def-meta-class |Collaboration|
 ...
 "A Collaboration describes a structure of collaborating elements (roles),
  ...
  ((|collaborationRole| :xmi-id "Collaboration-collaborationRole"
...
(def-meta-class |CollaborationUse|
 ...
 "A CollaborationUse is used to specify the application of a pattern specified
  ...
  ((|roleBinding| :xmi-id "CollaborationUse-roleBinding"
    :range |Dependency| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :documentation
     "A mapping between features of the Collaboration and features of the owning
      ...
      roles).")
   (|type| :xmi-id "CollaborationUse-type"
    :range |Collaboration| :multiplicity (1 1)
    :documentation
...
(def-meta-class |Component|
 ...
 "A Component represents a modular part of a system that encapsulates its
  ...
  ((|isIndirectlyInstantiated| :xmi-id "Component-isIndirectlyInstantiated"
    :range |Boolean| :multiplicity (1 1) :default :true
    :documentation
   ...
   (|packagedElement| :xmi-id "Component-packagedElement"
   ...
   (|provided| :xmi-id "Component-provided"
   ...
   (|realization| :xmi-id "Component-realization"
    :range |ComponentRealization| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    ...
    :documentation
     "The set of Realizations owned by the Component. Realizations reference
      ...
      its behavior.")
   (|required| :xmi-id "Component-required"
    :range |Interface| :multiplicity (0 -1) :is-readonly-p T :is-derived-p T
    :documentation
...
(def-meta-class |ComponentRealization|
 ...
 "Realization is specialized to (optionally) define the Classifiers that
  ...
  Classifiers."
  ((|abstraction| :xmi-id "ComponentRealization-abstraction"
    :range |Component| :multiplicity (0 1)
   ...
   (|realizingClassifier| :xmi-id "ComponentRealization-realizingClassifier"
    :range |Classifier| :multiplicity (1 -1)
   ...
   (|isDeterminate| :xmi-id "ConditionalNode-isDeterminate"
    ...
    :documentation
     "If true, the modeler asserts that the test for at most one Clause of the
      ConditionalNode will succeed.")
   (|result| :xmi-id "ConditionalNode-result"
    :range |OutputPin| :multiplicity (0 -1) :is-composite-p T :is-ordered-p T
    :documentation
...
(def-meta-class |ConnectableElement|
 ...
 "ConnectableElement is an abstract metaclass representing a set of instances
  ...
  ((|end| :xmi-id "ConnectableElement-end"
    :range |ConnectorEnd| :multiplicity (0 -1) :is-readonly-p T :is-derived-p T
    :opposite (|ConnectorEnd| |role|)
    :documentation
     "A set of ConnectorEnds that attach to this ConnectableElement.")
   (|templateParameter| :xmi-id "ConnectableElement-templateParameter"
    :range |ConnectableElementTemplateParameter| :multiplicity (0 1)
...
(def-meta-class |ConnectableElementTemplateParameter|
 ...
 "A ConnectableElementTemplateParameter exposes a ConnectableElement as a
  ...
  ((|parameteredElement| :xmi-id "ConnectableElementTemplateParameter-parameteredElement"
...
(def-meta-class |Connector|
 ...
 "A Connector specifies links that enables communication between two or more
  ...
  ((|contract| :xmi-id "Connector-contract"
    :range |Behavior| :multiplicity (0 -1)
    :documentation
   ...
   (|kind| :xmi-id "Connector-kind"
    :range |ConnectorKind| :multiplicity (1 1) :is-readonly-p T :is-derived-p T
    :documentation
...
(def-meta-constraint |two_input_parameters| |DecisionNode|
   "If the DecisionNode has a decisionInputFlow and an second incoming ObjectFlow,
    ...
    on the non-decisionInputFlow and the second of which has a type that is
...
(def-meta-class |Deployment|
 ...
 "A deployment is the allocation of an artifact or artifact instance to a
  ...
  files."
  ((|configuration| :xmi-id "Deployment-configuration"
    :range |DeploymentSpecification| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
   ...
   (|deployedArtifact| :xmi-id "Deployment-deployedArtifact"
    :range |DeployedArtifact| :multiplicity (0 -1)
   ...
   (|location| :xmi-id "Deployment-location"
    :range |DeploymentTarget| :multiplicity (1 1)
...
(def-meta-class |DeploymentSpecification|
 ...
 "A deployment specification specifies a set of properties that determine
  ...
  ((|deployment| :xmi-id "DeploymentSpecification-deployment"
    :range |Deployment| :multiplicity (0 1)
    :subsetted-properties ((|Element| |owner|))
    :opposite (|Deployment| |configuration|)
    :documentation
     "The deployment with which the DeploymentSpecification is associated.")
   (|deploymentLocation| :xmi-id "DeploymentSpecification-deploymentLocation"
    :range |String| :multiplicity (0 1)
    :documentation
     "The location where an Artifact is deployed onto a Node. This is typically
      a 'directory' or 'memory address.'")
   (|executionLocation| :xmi-id "DeploymentSpecification-executionLocation"
    :range |String| :multiplicity (0 1)
    :documentation
...
(def-meta-class |DurationConstraint|
 ...
 "A DurationConstraint is a Constraint that refers to a DurationInterval."
  ((|firstEvent| :xmi-id "DurationConstraint-firstEvent"
    :range |Boolean| :multiplicity (0 2)
    :documentation
...
(def-meta-class |DurationObservation|
 ...
 "A DurationObservation is a reference to a duration during an execution.
  ...
  ((|event| :xmi-id "DurationObservation-event"
    :range |NamedElement| :multiplicity (1 2) :is-ordered-p T
    :documentation
...
(def-meta-class |EncapsulatedClassifier|
 ...
 "An EncapsulatedClassifier may own Ports to specify typed interaction points."
  ((|ownedPort| :xmi-id "EncapsulatedClassifier-ownedPort"
    :range |Port| :multiplicity (0 -1) :is-readonly-p T :is-composite-p T :is-derived-p T
...
(def-meta-class |ExceptionHandler|
 ...
 "An ExceptionHandler is an Element that specifies a handlerBody ExecutableNode
  ...
  ((|exceptionInput| :xmi-id "ExceptionHandler-exceptionInput"
    :range |ObjectNode| :multiplicity (1 1)
    :documentation
   ...
   (|exceptionType| :xmi-id "ExceptionHandler-exceptionType"
    :range |Classifier| :multiplicity (1 -1)
    :documentation
   ...
   (|handlerBody| :xmi-id "ExceptionHandler-handlerBody"
    :range |ExecutableNode| :multiplicity (1 1)
    :documentation
     "An ExecutableNode that is executed if the ExceptionHandler catches an exception.")
   (|protectedNode| :xmi-id "ExceptionHandler-protectedNode"
    :range |ExecutableNode| :multiplicity (1 1)
    :subsetted-properties ((|Element| |owner|))
...
(def-meta-class |ExecutableNode|
 ...
 "An ExecutableNode is an abstract class for ActivityNodes whose execution
  ...
  be attached."
  ((|handler| :xmi-id "ExecutableNode-handler"
    :range |ExceptionHandler| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
...
(def-meta-class |ExpansionNode|
 ...
 "An ExpansionNode is an ObjectNode used to indicate a collection input or
  ...
  ((|regionAsInput| :xmi-id "ExpansionNode-regionAsInput"
    :range |ExpansionRegion| :multiplicity (0 1)
    :opposite (|ExpansionRegion| |inputElement|)
    :documentation
     "The ExpansionRegion for which the ExpansionNode is an input.")
   (|regionAsOutput| :xmi-id "ExpansionNode-regionAsOutput"
    :range |ExpansionRegion| :multiplicity (0 1)
...
(def-meta-class |ExpansionRegion|
 ...
 "An ExpansionRegion is a StructuredActivityNode that executes its content
  ...
  ((|inputElement| :xmi-id "ExpansionRegion-inputElement"
    :range |ExpansionNode| :multiplicity (1 -1)
    :opposite (|ExpansionNode| |regionAsInput|)
    :documentation
     "The ExpansionNodes that hold the input collections for the ExpansionRegion.")
   (|mode| :xmi-id "ExpansionRegion-mode"
    :range |ExpansionKind| :multiplicity (1 1) :default :iterative
    :documentation
   ...
   (|outputElement| :xmi-id "ExpansionRegion-outputElement"
    :range |ExpansionNode| :multiplicity (0 -1)
...
(def-meta-class |ExtensionEnd|
 ...
 "An extension end is used to tie an extension to a stereotype when extending
  ...
  ((|lower| :xmi-id "ExtensionEnd-lower"
    :range |Integer| :multiplicity (0 1) :is-derived-p T
    :documentation
...
(def-meta-class |InteractionUse|
 ...
 "An InteractionUse refers to an Interaction. The InteractionUse is a shorthand
  ...
  ((|actualGate| :xmi-id "InteractionUse-actualGate"
   ...
   (|returnValue| :xmi-id "InteractionUse-returnValue"
    :range |ValueSpecification| :multiplicity (0 1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :documentation
     "The value of the executed Interaction.")
   (|returnValueRecipient| :xmi-id "InteractionUse-returnValueRecipient"
    :range |Property| :multiplicity (0 1)
    :documentation
...
(def-meta-class |Interface|
 ...
 "Interfaces declare coherent services that are implemented by BehavioredClassifiers
  ...
  ((|nestedClassifier| :xmi-id "Interface-nestedClassifier"
   ...
   (|protocol| :xmi-id "Interface-protocol"
    :range |ProtocolStateMachine| :multiplicity (0 1) :is-composite-p T
    :subsetted-properties ((|Namespace| |ownedMember|))
    :documentation
...
(def-meta-constraint |interaction_uses_share_lifeline| |Lifeline|
   "If a lifeline is in an Interaction referred to by an InteractionUse in
    ...
    enclosing Interaction, it must be common to a lifeline within that enclosing
...
(def-meta-class |LoopNode|
 ...
 "A LoopNode is a StructuredActivityNode that represents an iterative loop
  ...
  ((|bodyOutput| :xmi-id "LoopNode-bodyOutput"
    :range |OutputPin| :multiplicity (0 -1) :is-ordered-p T
    :documentation
   ...
   (|loopVariable| :xmi-id "LoopNode-loopVariable"
    :range |OutputPin| :multiplicity (0 -1) :is-composite-p T :is-ordered-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :documentation
   ...
   (|loopVariableInput| :xmi-id "LoopNode-loopVariableInput"
    :range |InputPin| :multiplicity (0 -1) :is-composite-p T :is-ordered-p T
    :documentation
...
(def-meta-class |Manifestation|
 ...
 "A manifestation is the concrete physical rendering of one or more model
  ...
  ((|utilizedElement| :xmi-id "Manifestation-utilizedElement"
    :range |PackageableElement| :multiplicity (1 1)
    :subsetted-properties ((|Dependency| |supplier|))
    :documentation
 ...
 "A Message defines a particular communication between Lifelines of an Interaction."
  ((|argument| :xmi-id "Message-argument"
   ...
   (|messageKind| :xmi-id "Message-messageKind"
    :range |MessageKind| :multiplicity (1 1) :is-readonly-p T :is-derived-p T
    :documentation
 ...
 "A multiplicity is a definition of an inclusive interval of non-negative
  ...
  ((|isOrdered| :xmi-id "MultiplicityElement-isOrdered"
   ...
   (|upper| :xmi-id "MultiplicityElement-upper"
    :range |UnlimitedNatural| :multiplicity (1 1) :is-derived-p T
    :documentation
...
(def-meta-class |NamedElement|
 ...
 "A NamedElement is an Element in a model that may have a name. The name
  ...
  ((|clientDependency| :xmi-id "NamedElement-clientDependency"
    :range |Dependency| :multiplicity (0 -1) :is-derived-p T
   ...
   (|nameExpression| :xmi-id "NamedElement-nameExpression"
    :range |StringExpression| :multiplicity (0 1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :documentation
...
(def-meta-class |Node|
 ...
 "A Node is computational resource upon which artifacts may be deployed for
  ...
  network structures."
  ((|nestedNode| :xmi-id "Node-nestedNode"
    :range |Node| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Namespace| |ownedMember|))
    :documentation
...
(def-meta-class |OpaqueAction|
 ...
 "An OpaqueAction is an Action whose functionality is not specified within
  ...
  ((|body| :xmi-id "OpaqueAction-body"
    :range |String| :multiplicity (0 -1) :is-ordered-p T
    :documentation
 ...
 "An Operation is a BehavioralFeature of a Classifier that specifies the
  ...
  ((|bodyCondition| :xmi-id "Operation-bodyCondition"
   ...
   (|lower| :xmi-id "Operation-lower"
    :range |Integer| :multiplicity (0 1) :is-readonly-p T :is-derived-p T
    :documentation
   ...
   (|templateParameter| :xmi-id "Operation-templateParameter"
    :range |OperationTemplateParameter| :multiplicity (0 1)
   ...
   (|upper| :xmi-id "Operation-upper"
    :range |UnlimitedNatural| :multiplicity (0 1) :is-readonly-p T :is-derived-p T
    :documentation
...
(def-meta-class |OperationTemplateParameter|
 ...
 "An OperationTemplateParameter exposes an Operation as a formal parameter
  for a template."
  ((|parameteredElement| :xmi-id "OperationTemplateParameter-parameteredElement"
    :range |Operation| :multiplicity (1 1)
 ...
 "A package can have one or more profile applications to indicate which profiles
  ...
  ((URI :xmi-id "Package-URI"
   ...
   (|ownedStereotype| :xmi-id "Package-ownedStereotype"
    :range |Stereotype| :multiplicity (0 -1) :is-readonly-p T :is-composite-p T :is-derived-p T
    :subsetted-properties ((|Package| |packagedElement|))
    :documentation
...
(def-meta-class |PackageableElement|
 ...
 "A PackageableElement is a NamedElement that may be owned directly by a
  ...
  ((|visibility| :xmi-id "PackageableElement-visibility"
    :range |VisibilityKind| :multiplicity (0 1) :default :public
    :documentation
...
(def-meta-class |ParameterableElement|
 ...
 "A ParameterableElement is an Element that can be exposed as a formal TemplateParameter
  ...
  ((|owningTemplateParameter| :xmi-id "ParameterableElement-owningTemplateParameter"
   ...
   (|templateParameter| :xmi-id "ParameterableElement-templateParameter"
    :range |TemplateParameter| :multiplicity (0 1)
...
(def-meta-constraint |assume| |PartDecomposition|
   "Assume that within Interaction X, Lifeline L is of class C and decomposed
    ...
    L is matched with a global (i.e., covering all Lifelines) InteractionUse
...
(def-meta-class |Port|
 ...
 "A Port is a property of an EncapsulatedClassifier that specifies a distinct
  ...
  ((|isBehavior| :xmi-id "Port-isBehavior"
   ...
   (|protocol| :xmi-id "Port-protocol"
    :range |ProtocolStateMachine| :multiplicity (0 1)
    :documentation
...
(def-meta-class |ProtocolConformance|
 ...
 "A ProtocolStateMachine can be redefined into a more specific ProtocolStateMachine
  ...
  ((|generalMachine| :xmi-id "ProtocolConformance-generalMachine"
...
(def-meta-class |ProtocolStateMachine|
 ...
 "A ProtocolStateMachine is always defined in the context of a Classifier.
  ...
  its existence."
  ((|conformance| :xmi-id "ProtocolStateMachine-conformance"
    :range |ProtocolConformance| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
...
(def-meta-class |ProtocolTransition|
 ...
 "A ProtocolTransition specifies a legal Transition for an Operation. Transitions
  ...
  ((|postCondition| :xmi-id "ProtocolTransition-postCondition"
    :range |Constraint| :multiplicity (0 1) :is-composite-p T
    :subsetted-properties ((|Namespace| |ownedRule|))
    :documentation
   ...
   (|preCondition| :xmi-id "ProtocolTransition-preCondition"
    :range |Constraint| :multiplicity (0 1) :is-composite-p T
   ...
   (|referred| :xmi-id "ProtocolTransition-referred"
    :range |Operation| :multiplicity (0 -1) :is-readonly-p T :is-derived-p T
    :documentation
...
(def-meta-class |RedefinableTemplateSignature|
 ...
 "A RedefinableTemplateSignature supports the addition of formal template
  ...
  ((|classifier| :xmi-id "RedefinableTemplateSignature-classifier"
    :range |Classifier| :multiplicity (1 1)
    :subsetted-properties ((|RedefinableElement| |redefinitionContext|))
   ...
   (|inheritedParameter| :xmi-id "RedefinableTemplateSignature-inheritedParameter"
    :range |TemplateParameter| :multiplicity (0 -1) :is-readonly-p T :is-derived-p T
...
(def-meta-operation |isConsistentWith| |Region|
   "The query isConsistentWith specifies that a Region can be redefined by
    ...
    Vertices and Transitions within a redefining Region are specified by the
...
(def-meta-operation |isConsistentWith| |State|
   "The query isConsistentWith specifies that a non-final State can only be
    ...
    is a submachine State, then the redefining State must be a submachine state
    whose submachine is a redefinition of the submachine of the redefined State.
    Note that consistency requirements for the redefinition of Regions and
    connectionPoint Pseudostates within a composite State and connection ConnectionPoints
...
(def-meta-operation |isConsistentWith| |StateMachine|
   "The query isConsistentWith specifies that a StateMachine can be redefined
    ...
    for the redefinition of Regions and connectionPoint Pseudostates owned
...
(def-meta-operation |isRedefinitionContextValid| |StateMachine|
   "The query isRedefinitionContextValid specifies whether the redefinition
    ...
    of a redefining StateMachine must specialize the context Classifier of
    the redefined StateMachine. If the redefining StateMachine does not have
    a context BehavioredClassifier, then then the redefining StateMachine also
 ...
 "A stereotype defines how an existing metaclass may be extended, and enables
  ...
  ((|icon| :xmi-id "Stereotype-icon"
   ...
   (|profile| :xmi-id "Stereotype-profile"
    :range |Profile| :multiplicity (1 1) :is-readonly-p T :is-derived-p T
    :documentation
...
(def-meta-class |StringExpression|
 ...
 "A StringExpression is an Expression that specifies a String value that
  ...
  ((|owningExpression| :xmi-id "StringExpression-owningExpression"
    :range |StringExpression| :multiplicity (0 1)
    :subsetted-properties ((|Element| |owner|))
    :opposite (|StringExpression| |subExpression|)
    :documentation
     "The StringExpression of which this StringExpression is a subExpression.")
   (|subExpression| :xmi-id "StringExpression-subExpression"
    :range |StringExpression| :multiplicity (0 -1) :is-composite-p T :is-ordered-p T
    :subsetted-properties ((|Element| |ownedElement|))
...
(def-meta-class |StructuredActivityNode|
 ...
 "A StructuredActivityNode is an Action that is also an ActivityGroup and
  ...
  ((|activity| :xmi-id "StructuredActivityNode-activity"
   ...
   (|mustIsolate| :xmi-id "StructuredActivityNode-mustIsolate"
    :range |Boolean| :multiplicity (1 1) :default :false
    :documentation
   ...
   (|structuredNodeInput| :xmi-id "StructuredActivityNode-structuredNodeInput"
    :range |InputPin| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Action| |input|))
    :documentation
     "The InputPins owned by the StructuredActivityNode.")
   (|structuredNodeOutput| :xmi-id "StructuredActivityNode-structuredNodeOutput"
    :range |OutputPin| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Action| |output|))
    :documentation
...
(def-meta-class |TemplateBinding|
 ...
 "A TemplateBinding is a DirectedRelationship between a TemplateableElement
  ...
  ((|boundElement| :xmi-id "TemplateBinding-boundElement"
   ...
   (|parameterSubstitution| :xmi-id "TemplateBinding-parameterSubstitution"
    :range |TemplateParameterSubstitution| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
    :opposite (|TemplateParameterSubstitution| |templateBinding|)
    :documentation
     "The TemplateParameterSubstitutions owned by this TemplateBinding.")
   (|signature| :xmi-id "TemplateBinding-signature"
    :range |TemplateSignature| :multiplicity (1 1)
    :subsetted-properties ((|DirectedRelationship| |target|))
    :documentation
...
(def-meta-class |TemplateParameter|
 ...
 "A TemplateParameter exposes a ParameterableElement as a formal parameter
  of a template."
  ((|default| :xmi-id "TemplateParameter-default"
    :range |ParameterableElement| :multiplicity (0 1)
    :documentation
   ...
   (|parameteredElement| :xmi-id "TemplateParameter-parameteredElement"
    :range |ParameterableElement| :multiplicity (1 1)
    :opposite (|ParameterableElement| |templateParameter|)
    :documentation
     "The ParameterableElement exposed by this TemplateParameter.")
   (|signature| :xmi-id "TemplateParameter-signature"
    :range |TemplateSignature| :multiplicity (1 1)
    :subsetted-properties ((|Element| |owner|))
...
(def-meta-class |TemplateParameterSubstitution|
 ...
 "A TemplateParameterSubstitution relates the actual parameter to a formal
  ...
  ((|actual| :xmi-id "TemplateParameterSubstitution-actual"
    :range |ParameterableElement| :multiplicity (1 1)
    :documentation
     "The ParameterableElement that is the actual parameter for this TemplateParameterSubstitution.")
   (|formal| :xmi-id "TemplateParameterSubstitution-formal"
    :range |TemplateParameter| :multiplicity (1 1)
    :documentation
   ...
   (|templateBinding| :xmi-id "TemplateParameterSubstitution-templateBinding"
    :range |TemplateBinding| :multiplicity (1 1)
    :subsetted-properties ((|Element| |owner|))
...
(def-meta-class |TemplateSignature|
 ...
 "A Template Signature bundles the set of formal TemplateParameters for a
  ...
  ((|ownedParameter| :xmi-id "TemplateSignature-ownedParameter"
   ...
   (|parameter| :xmi-id "TemplateSignature-parameter"
    :range |TemplateParameter| :multiplicity (1 -1) :is-ordered-p T
    :documentation
     "The ordered set of all formal TemplateParameters for this TemplateSignature.")
   (|template| :xmi-id "TemplateSignature-template"
    :range |TemplateableElement| :multiplicity (1 1)
    :subsetted-properties ((|Element| |owner|))
...
(def-meta-class |TemplateableElement|
 ...
 "A TemplateableElement is an Element that can optionally be defined as a
  ...
  ((|ownedTemplateSignature| :xmi-id "TemplateableElement-ownedTemplateSignature"
    :range |TemplateSignature| :multiplicity (0 1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
   ...
   (|templateBinding| :xmi-id "TemplateableElement-templateBinding"
    :range |TemplateBinding| :multiplicity (0 -1) :is-composite-p T
    :subsetted-properties ((|Element| |ownedElement|))
 ...
 "An UnmarshallAction is an Action that retrieves the values of the StructuralFeatures
  ...
  ((|object| :xmi-id "UnmarshallAction-object"
   ...
   (|result| :xmi-id "UnmarshallAction-result"
    :range |OutputPin| :multiplicity (1 -1) :is-composite-p T :is-ordered-p T
    :subsetted-properties ((|Action| |output|))
    :documentation
 ...
 "A Vertex is an abstraction of a node in a StateMachine graph. It can be
  ...
  ((|container| :xmi-id "Vertex-container"
   ...
   (|incoming| :xmi-id "Vertex-incoming"
    :range |Transition| :multiplicity (0 -1) :is-readonly-p T :is-derived-p T
   ...
   (|redefinedVertex| :xmi-id "State-redefinedState"
    :range |Vertex| :multiplicity (0 1)
    :subsetted-properties ((|RedefinableElement| |redefinedElement|))
    :documentation
...
(def-meta-operation |isConsistentWith| |Vertex|
   "The query isRedefinitionContextValid specifies that the redefinition context
    ...
    of the owner of the redefined Vertex. Note that the owner of a Vertex may
    be a Region, a StateMachine (for a connectionPoint Pseudostate), or a State
