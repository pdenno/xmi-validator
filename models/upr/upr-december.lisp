...
;;; POD: was |applyTo|
(def-meta-operation "applyTo1" |ComparisonOperator| 
   "This operation evaluates an UPRConstraint base on the semantics specified
    for that operator"
   :operation-body
   "self.applyTo2(c.base_Constraint.constrainedElement-&gt;at(1), c.base_Constraint.constrainedElement-&gt;at(2))"
   :parameters
...
(def-meta-operation "applyTo2" |EQ_Operator| 
   ""
   :operation-body
...
(def-meta-operation "applyTo2" |GTE_Operator| 
   ""
   :operation-body
   "if (x.oclIsKindOf(Real) and y.oclIsKindOf(Real)) then x.oclAsType(Real) &gt;= y.oclAsType(Real) else OclInvalid endif"
   :parameters
...
(def-meta-operation "applyTo2" |GT_Operator| 
   ""
   :operation-body
   "if (x.oclIsKindOf(Real) and y.oclIsKindOf(Real)) then x.oclAsType(Real) &gt; y.oclAsType(Real) else OclInvalid endif"
   :parameters
...
(def-meta-operation "applyTo2" |LTE_Operator| 
   ""
   :operation-body
   "if (x.oclIsKindOf(Real) and y.oclIsKindOf(Real)) then x.oclAsType(Real) &lt;= y.oclAsType(Real) else OclInvalid endif"
   :parameters
...
(def-meta-operation "applyTo2" |LT_Operator| 
   ""
   :operation-body
   "if (x.oclIsKindOf(Real) and y.oclIsKindOf(Real)) then x.oclAsType(Real) &lt; y.oclAsType(Real) else OclInvalid endif"
   :parameters
...
(def-meta-operation "applyTo2" |NEQ_Operator| 
   ""
   :operation-body
   "if (x.oclIsKindOf(Real) and y.oclIsKindOf(Real)) then x.oclAsType(Real) &lt;&gt; y.oclAsType(Real) else OclInvalid endif"
   :parameters
...
(def-meta-operation "applyTo2" |OperatorSemantics| 
   ""
   :operation-body
   "self.base_Class.oclAsType(OperatorSemanticsClass).applyTo2(x, y)"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T)
          (make-instance 'ocl-parameter :parameter-name '\x :parameter-type 'UML25:|Element|
...
(def-meta-operation "applyTo2" |OperatorSemanticsClass| 
...
(def-meta-operation "evaluate" |UPRConstraint| 
   ""
   :operation-body
   "self.comparisonOperator.applyTo1(self.base_Constraint)"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
