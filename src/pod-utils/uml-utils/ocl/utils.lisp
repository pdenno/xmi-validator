...
;;; ToDo: Without the class spec, this is a rather weak test. It iterates over all models.
;;;       It does little more than check that something an some model in scope has such an attribute.
