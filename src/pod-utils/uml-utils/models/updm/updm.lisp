;;; Automatically created by pop-gen at 2013-04-11 16:16:10.
;;; Source file is UPDM-Profile-2012-08-14-hrefs-fixed.xmi
...
(def-meta-stereotype |Activity| 
   (:model :UPDM :superclasses (|Desirer|) :extends NIL
...
(def-meta-stereotype |Capability| 
   (:model :UPDM :superclasses (|PropertySet| |Desirer| SOAML:|Capability|) :extends (UML23:|Class|)
...
(def-meta-stereotype |ExchangeElement| 
   (:model :UPDM :superclasses (|ResourceInteractionItem| |SubjectOfOperationalConstraint| |OperationalExchangeItem|) :extends (UML23:|DataType|)
...
(def-meta-stereotype |Node| 
   (:model :UPDM :superclasses (|SubjectOfOperationalStateMachine| |SubjectOfOperationalConstraint| |NodeParent|) :extends (UML23:|Class|)
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |OperationalElements| |Structure|) 
...
(def-meta-stereotype |Participant| 
   (:model :UPDM :superclasses (|CapableElement| |OperationalExchangeItem| SOAML:|Participant| |Desirer| |ConceptItem|) :extends NIL
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |AllElements| |Structure|) 
...
(def-meta-stereotype |Request| 
   (:model :UPDM :superclasses (SOAML:|Request| |ServicePort|) :extends (UML23:|Port|)
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |ServiceElements| |Structure|) 
...
(def-meta-stereotype |Service| 
   (:model :UPDM :superclasses (|ServicePort| SOAML:|Service|) :extends (UML23:|Port|)
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |ServiceElements| |Structure|) 
...
(def-meta-stereotype |ServiceInterface| 
   (:model :UPDM :superclasses (SOAML:|ServiceInterface| |PropertySet|) :extends (UML23:|Class|)
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |ServiceElements| |Structure|) 
...
(def-meta-stereotype |SystemResource| 
   (:model :UPDM :superclasses (|SubjectOfForecast| |Participant| |ResourceInteractionItem|) :extends (UML23:|Class|)
 :packages (UPDM UPDM\ L1 UPDM\ L0 |Core| |SystemsElements| |Structure|) 
...
(def-meta-package |StandardProfileL2-20090901| NIL :UPDM 
   () :xmi-id NIL)
