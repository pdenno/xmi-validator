...
(ensure-model :ptypes
  ...
  :postload-path (pod:lpath :mylib "pod-utils/uml-utils/ocl/ptypes.lisp")
...
(ensure-model :ocl
  ...
  :model-class 'essential-lexical-model
  :nicknames '("OCL")
  :postload-path (pod:lpath :mylib "pod-utils/uml-utils/ocl/types.lisp") ; <====== Different!
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/mof/mof-mm.lisp")
 :ns-prefix "MOFI")
...
(mofi:ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/cmof/cmof.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/cmof/cmof-postload.lisp")
...
(mofi:ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml23.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml23-postload.lisp")
...
(mofi:ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml241.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml241-postload.lisp")
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/qvt/qvt-mm.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/qvt/qvt-postload.lisp")
