...
(ensure-model 
 ...
 :model-n+1 :uml23
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml-std-profile-l2-20090901.lisp")
...
(ensure-model 
 ...
 :model-class 'mofi::profile
 :model-n+1 :uml241
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml-std-profile-l2-20110701.lisp")
 :href-uri "http://www.omg.org/spec/UML/20110701/StandardProfileL2.xmi"
...
; :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml25.lisp")
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml25.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml25-postload.lisp")
...
(ensure-model 
 ...
 :model-class 'mofi::profile
 :model-n+1 :uml25
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml-std-profile-20131001.lisp")
 :href-uri "http://www.omg.org/spec/UML/20131001/StandardProfile.xmi"
...
(mofi:ensure-model 
 ...
 :model-class 'mofi:essential-compiled-model
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/fuml/fuml.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/fuml/fuml-postload.lisp")
...
XMI_file 	(1510529 bytes) 	alternate"
 :model-class 'mofi:essential-compiled-model
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml22.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml22-postload.lisp")
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/qudv/qudv.lisp"))
...
;;; Next two are typically set in popgen-erated .lisp
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/sysml/sysml-profile-14.lisp")
...
;;; Next two are typically set in popgen-erated .lisp
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/sysml/sysml-profile-13.lisp")
...
(mofi:ensure-model 
 ...
 :model-class 'mofi:essential-compiled-model
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/uml4sysml12.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/uml/um4sysml12-postload.lisp")
...
;;; :ns-uri "http://www.omg.org/spec/SysML/20100301/SysML-profile"
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/sysml/sysml-profile-12.lisp")
...
;;; Next two are typically set in popgen-erated .lisp
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/soaml/soaml-profile.lisp")
...
(ensure-model 
 ...
 :model-class 'mofi::profile
 :depends-on-models '(:ocl :uml-profile-l2-20090901 :uml23 )
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/niem/niem.lisp")
 :ns-prefix "NIEM")
...
(ensure-model 
 ...
 :model-n+1 :uml23
 :depends-on-models '(:ocl :uml-profile-l2-20110701 :uml23)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/updm/updm.lisp")
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/odm/13-11-01/rdf-profile.lisp")
...
(ensure-model 
 ...
 :model-n+1 :uml241
 :depends-on-models '(:ocl :uml-profile-l2-20110701 :uml241)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/odm/13-11-01/owl-profile.lisp")
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/odm/13-11-01/odm-13-11-01.lisp")
 :postload-path (pod:lpath :mylib "pod-utils/uml-utils/models/odm/13-11-01/odm-13-11-01-postload.lisp")
...
(ensure-model 
 ...
 :model-n+1 :uml23
 :depends-on-models '(:ocl :uml-profile-l2-20110701 :uml23)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/updm/updm-my-2012-11-09.lisp")
...
(ensure-model 
 ...
 :model-n+1 :uml25
 :depends-on-models '(:ocl :uml-profile-20131001 :uml25)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/upr/upr-december.lisp")
...
(ensure-model 
 ...
 :model-n+1 :uml25
 :depends-on-models '(:ocl :uml-profile-20131001 :uml25)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/upr/upr-august.lisp")
...
(ensure-model 
 ...
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/bpmn/bpmn.lisp"))
...
(ensure-model 
 ...
 :model-class 'mofi::profile
 :depends-on-models '(:ocl :uml23)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/bpmn/bpmn-profile/bpmnpro.lisp")
...
;	      "BPMN2 Constraints.mdzip#_16_8beta_8740266_1261484630687_217688_1428"
 ...
 :model-class 'mofi::profile
 :depends-on-models '(:ocl :uml241)
 :classes-path (pod:lpath :mylib "pod-utils/uml-utils/models/bpmn/bpmn-profile.lisp"))
