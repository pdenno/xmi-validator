...
(def-mm-class.name |ABox| (:ODM DL) (|TBox|)
   ""
  ((|content| :range |Instance| :multiplicity (0 -1 )
  :is-derived-p t )))


(def-mm-class.name |AllValuesFromRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |Argument| (:ODM CL) NIL
"  A finite sequence of terms or sequence names"
  ())


(def-mm-class.name |Assertion| (:ODM DL) (|Instance|)
...
(def-mm-class.name |Association| (:ODM TM) (|TypeAble| |ScopeAble| |ReifiableConstruct|)
   ""
  ((|parent| :range |TopicMap| :multiplicity (1 1 ))
   (|role| :range |AssociationRole| :multiplicity (1 -1 ) :is-composite-p t )))


(def-mm-class.name |AssociationRole| (:ODM TM) (|ReifiableConstruct| |TypeAble|)
   ""
  ((|parent| :range |Association| :multiplicity (1 1 ))
   (|player| :range |Topic| :multiplicity (1 1 ))))


(def-mm-class.name |Atom| (:ODM CL) (|Sentence|)
   ""
  ())


(def-mm-class.name |AtomicSentence| (:ODM CL) (|Atom|)
   ""
...
(def-mm-class.name |BooleanSentence| (:ODM CL) (|Sentence|)
   ""
  ())


(def-mm-class.name |CardinalityRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |Class| (:ODM |ERIdentity|) NIL
   ""
  ())


(def-mm-class.name |Collection| (:ODM DL) (|Concept|)
   ""
  ((|member| :range |Extent| :multiplicity (0 -1 ))))


(def-mm-class.name |Comment| (:ODM CL) (|Phrase|)
...
(def-mm-class.name |CommentedSentence| (:ODM CL) (|Sentence|)
   ""
  ((|comment| :range NIL :multiplicity (1 1 ))
   (|sentence| :range |Sentence| :multiplicity (1 1 ))))


(def-mm-class.name |CommentedTerm| (:ODM CL) (|Term|)
   ""
  ((|comment| :range NIL :multiplicity (1 1 ))
   (|term| :range |Term| :multiplicity (1 1 ))))


(def-mm-class.name |ComplementClass| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |Concept| (:ODM DL) (|Element|)
   ""
  ((|member| :range |Individual| :multiplicity (0 -1 ))))


(def-mm-class.name |Conjunction| (:ODM CL) (|BooleanSentence|)
   ""
  ((|conjunct| :range |Sentence| :multiplicity (0 -1 ))))


(def-mm-class.name |Constructor| (:ODM DL) NIL
   ""
  ())


(def-mm-class.name |DataType| (:ODM DL) (|Concept|)
   ""
  ((|member| :range |Literal| :multiplicity (0 -1 ))))


(def-mm-class.name |Definition| (:ODM DL) (|Constructor|)
"  DLHB 2.2.2.1"
  ())


(def-mm-class.name |Disjunction| (:ODM CL) (|BooleanSentence|)
   ""
  ((|disjunct| :range |Sentence| :multiplicity (0 -1 ))))


(def-mm-class.name |Document| (:ODM |RDFWeb|) (|RDFSResource|)
...
(def-mm-class.name |Element| (:ODM DL) (|Term|)
   ""
...
(def-mm-class.name |EnumeratedClass| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |Equation| (:ODM CL) (|Atom|)
   ""
  ((|lvalue| :range |Term| :multiplicity (1 1 ))
   (|rvalue| :range |Term| :multiplicity (1 1 ))))


(def-mm-class.name |ExclusionSet| (:ODM CL) NIL
...
(def-mm-class.name |Existential| (:ODM DL) (|Quantifier|)
"  DLHB 2.2.1.2"
  ())


(def-mm-class.name |ExistentialQuantification| (:ODM CL) (|QuantifiedSentence|)
   ""
  ())


(def-mm-class.name |Expression| (:ODM DL) (|Term|)
   ""
...
(def-mm-class.name |Extent| (:ODM DL) (|Individual|)
   ""
  ((|instance| :range |Instance| :multiplicity (0 -1 ))
   (|type| :range |Collection| :multiplicity (1 -1 ))))


(def-mm-class.name |ForAll| (:ODM DL) (|Quantifier|)
   ""
  ())


(def-mm-class.name |FunctionalProperty| (:ODM |OWLBase|) (|Property|)
...
(def-mm-class.name |FunctionalTerm| (:ODM CL) (|Term|)
   ""
  ((|argument| :range |Argument| :multiplicity (0 -1 )
  :is-ordered-p t )
...
(def-mm-class.name |HasValueRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |Identifier| (:ODM |ERIdentity|) NIL
   ""
...
(def-mm-class.name |Identifier| (:ODM CL) (|Name|)
   ""
  ())


(def-mm-class.name |Implication| (:ODM CL) (|BooleanSentence|)
   ""
  ((|antecedent| :range |Sentence| :multiplicity (1 1 ))
   (|consequent| :range |Sentence| :multiplicity (1 1 ))))


(def-mm-class.name |Implication| (:ODM DL) (|Constructor|)
"  DLHB 2.2.5"
  ())


(def-mm-class.name |Importation| (:ODM CL) (|Phrase|)
...
(def-mm-class.name |Inclusion| (:ODM DL) (|Constructor|)
"  DLHB 2.2.2.1"
  ())


(def-mm-class.name |Individual| (:ODM |OWLBase|) (|OWLUniverse| |RDFSResource|)
...
(def-mm-class.name |Individual| (:ODM DL) (|Instance| |Element|)
"  Set of instances that make up a DLClass"
  ((|type| :range |Concept| :multiplicity (1 -1 ))))


(def-mm-class.name |Instance| (:ODM DL) (|Term|)
   ""
  ())


(def-mm-class.name |Intersection| (:ODM DL) (|Constructor|)
"  DLHB 2.2.1.1"
  ())


(def-mm-class.name |IntersectionClass| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |InverseFunctionalProperty| (:ODM |OWLBase|) (|OWLObjectProperty|)
...
(def-mm-class.name |IrregularSentence| (:ODM CL) (|Sentence|)
   ""
  ())


(def-mm-class.name |List| (:ODM DL) (|Collection|)
"  A List is an order collection."
  ())


(def-mm-class.name |Literal| (:ODM DL) (|Individual|)
   ""
...
(def-mm-class.name |LocalName| (:ODM |RDFWeb|) NIL
...
(def-mm-class.name |MaxCardinalityRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |MinCardinalityRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |Module| (:ODM CL) (|Phrase|)
...
(def-mm-class.name |Name| (:ODM CL) (|Term|)
...
(def-mm-class.name |NamedGraph| (:ODM |RDFBase|) (|RDFSResource|)
   ""
...
(def-mm-class.name |Namespace| (:ODM |RDFWeb|) NIL
...
(def-mm-class.name |NamespaceDefinition| (:ODM |RDFWeb|) NIL
...
(def-mm-class.name |Negation| (:ODM CL) (|BooleanSentence|)
   ""
  ((|sentence| :range |Sentence| :multiplicity (1 1 ))))


(def-mm-class.name |Negation| (:ODM DL) (|Constructor|)
"  DLHB 2.2.1.1"
  ())


(def-mm-class.name |Node| (:ODM |RDFBase|) (|RDFSResource|)
"  The set of nodes of an RDF graph is the set of subjects and objects of
  triples in the graph."
  ())


(def-mm-class.name |NumberRestiction| (:ODM DL) (|Quantifier|)
"  DLHB 2.2.1.2"
  ())


(def-mm-class.name |OWLAllDifferent| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |OWLAnnotationProperty| (:ODM |OWLBase|) (|RDFProperty| |OWLUniverse|)
...
(def-mm-class.name |OWLClass| (:ODM |OWLBase|) (|RDFSClass| |OWLUniverse|)
...
(def-mm-class.name |OWLDataRange| (:ODM |OWLBase|) (|OWLUniverse| |RDFSClass|)
...
(def-mm-class.name |OWLDatatypeProperty| (:ODM |OWLBase|) (|Property|)
...
(def-mm-class.name |OWLGraph| (:ODM |OWLBase|) (|RDFGraph|)
...
(def-mm-class.name |OWLObjectProperty| (:ODM |OWLBase|) (|Property|)
...
(def-mm-class.name |OWLOntology| (:ODM |OWLBase|) (|RDFSResource|)
...
(def-mm-class.name |OWLOntologyProperty| (:ODM |OWLBase|) (|RDFProperty| |OWLUniverse|)
...
(def-mm-class.name |OWLRestriction| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |OWLUniverse| (:ODM |OWLBase|) (|RDFSResource|)
   ""
  ((|ontology| :range |OWLOntology| :multiplicity (1 -1 ))))


(def-mm-class.name |Occurrence| (:ODM TM) (|ReifiableConstruct| |TypeAble| |ScopeAble|)
...
(def-mm-class.name |Phrase| (:ODM CL) NIL
...
(def-mm-class.name |PlainLiteral| (:ODM |RDFBase|) (|RDFSLiteral|)
...
(def-mm-class.name |Property| (:ODM |OWLBase|) (|RDFProperty| |OWLUniverse|)
...
(def-mm-class.name |Property| (:ODM |ERIdentity|) NIL
   ""
  ())


(def-mm-class.name |QuantifiedSentence| (:ODM CL) (|Sentence|)
   ""
...
(def-mm-class.name |Quantifier| (:ODM DL) (|Constructor|)
"  DLHB 2.2.1"
  ())


(def-mm-class.name |RDFAlt| (:ODM RDFS) (|RDFSContainer|)
...
(def-mm-class.name |RDFBag| (:ODM RDFS) (|RDFSContainer|)
...
(def-mm-class.name |RDFGraph| (:ODM |RDFBase|) NIL
...
(def-mm-class.name |RDFList| (:ODM RDFS) (|RDFSResource|)
...
(def-mm-class.name |RDFProperty| (:ODM |RDFBase|) (|RDFSResource|)
...
(def-mm-class.name |RDFSClass| (:ODM RDFS) (|RDFSResource|)
...
(def-mm-class.name |RDFSContainer| (:ODM RDFS) (|RDFSResource|)
"  This is a super-class of RDF container classes."
  ())


(def-mm-class.name |RDFSContainerMembershipProperty| (:ODM RDFS) (|RDFProperty|)
...
(def-mm-class.name |RDFSDatatype| (:ODM RDFS) (|RDFSClass|)
...
(def-mm-class.name |RDFSLiteral| (:ODM |RDFBase|) (|Node|)
...
(def-mm-class.name |RDFSResource| (:ODM |RDFBase|) NIL
...
(def-mm-class.name |RDFSeq| (:ODM RDFS) (|RDFSContainer|)
...
(def-mm-class.name |RDFStatement| (:ODM |RDFBase|) (|RDFSResource|)
...
(def-mm-class.name |RDFXMLLiteral| (:ODM |RDFBase|) (|TypedLiteral|)
...
(def-mm-class.name |ReifiableConstruct| (:ODM TM) (|TopicMapConstruct|)
   ""
  ((|reified| :range |Topic| :multiplicity (0 1 ))))


(def-mm-class.name |Role| (:ODM DL) (|Element|)
   ""
  ((|member| :range |Assertion| :multiplicity (0 -1 ))))


(def-mm-class.name |ScopeAble| (:ODM TM) NIL
   ""
  ((|scope| :range |Topic| :multiplicity (0 -1 ))))


(def-mm-class.name |Sentence| (:ODM CL) (|Phrase|)
...
(def-mm-class.name |SequenceMarker| (:ODM CL) (|Argument|)
   ""
  ())


(def-mm-class.name |Set| (:ODM DL) (|Collection|)
"  A set is a collection of unique members."
  ())


(def-mm-class.name |SomeValuesFromRestriction| (:ODM |OWLBase|) (|OWLRestriction|)
...
(def-mm-class.name |SymmetricProperty| (:ODM |OWLBase|) (|OWLObjectProperty|)
...
(def-mm-class.name |Text| (:ODM CL) NIL
...
(def-mm-class.name |Topic| (:ODM TM) (|TopicMapConstruct|)
...
(def-mm-class.name |Triple| (:ODM |RDFBase|) NIL
...
(def-mm-class.name |TypeAble| (:ODM TM) NIL
   ""
  ((|type| :range |Topic| :multiplicity (1 1 ))))


(def-mm-class.name |TypedLiteral| (:ODM |RDFBase|) (|RDFSLiteral|)
...
(def-mm-class.name |URIReference| (:ODM |RDFBase|) NIL
...
(def-mm-class.name |URIReferenceNode| (:ODM |RDFBase|) (|Node|)
...
(def-mm-class.name |UniformResourceIdentifier| (:ODM |RDFBase|) (|URIReference|)
...
(def-mm-class.name |Union| (:ODM DL) (|Constructor|)
"  DLHB 2.2.1.2"
  ())


(def-mm-class.name |UnionClass| (:ODM |OWLBase|) (|OWLClass|)
...
(def-mm-class.name |UniversalQuantification| (:ODM CL) (|QuantifiedSentence|)
   ""
  ())


(def-mm-class.name |Variant| (:ODM TM) (|ReifiableConstruct|)
