;;; Automatically created by pop-gen at 2011-02-05 16:59:49.
...
;;; ====================== AdHocSubProcess
;;; =========================================================
(def-mm-stereotype |AdHocSubProcess| (:BPMN-P) (|SubProcess|) (UML23:|StructuredActivityNode|) 
...
;;; ====================== Assignment
;;; =========================================================
(def-mm-stereotype |Assignment| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; ====================== Association
;;; =========================================================
(def-mm-stereotype |Association| (:BPMN-P) (|BPMNArtifact|) (UML23:|Dependency|) 
...
;;; ====================== AttributeProperty
;;; =========================================================
(def-mm-stereotype |AttributeProperty| (:BPMN-P) (|BPMNProperty|) (UML23:|Property|) 
 ""
  ())
...
;;; ====================== Auditing
;;; =========================================================
(def-mm-stereotype |Auditing| (:BPMN-P) (|BaseElement|) (UML23:|Dependency|) 
...
;;; ====================== BPMNActivity
;;; =========================================================
(def-mm-stereotype |BPMNActivity| (:BPMN-P) (|FlowNode|) (UML23:|Action|) 
 "An Activity is work that is performed within a Business Process. An Activity
  ...
  ((|boundaryEventRefs| :range |BoundaryEvent| :multiplicity (0 -1)
   ...
   (|dataInputs| :range |DataInput| :multiplicity (:* -1))
...
;;; ====================== BPMNArtifact
;;; =========================================================
(def-mm-stereotype |BPMNArtifact| (:BPMN-P) (|BaseElement|) (UML23:|Comment| UML23:|Dependency|) 
...
;;; ====================== BPMNExpression
;;; =========================================================
(def-mm-stereotype |BPMNExpression| (:BPMN-P) (|BaseElement|) (UML23:|OpaqueExpression|) 
...
;;; ====================== BPMNImport
;;; =========================================================
(def-mm-stereotype |BPMNImport| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; ====================== BPMNInterface
;;; =========================================================
(def-mm-stereotype |BPMNInterface| (:BPMN-P) (|RootElement|) (UML23:|Interface|) 
...
;;; ====================== BPMNProcess
;;; =========================================================
(def-mm-stereotype |BPMNProcess| (:BPMN-P) (|CallableElement|) (UML23:|Activity|) 
 "A Process describes a sequence or flow of Activities in an enterprise with
  ...
  ((|correlationSubscriptions| :range |CorrelationSubscription| :multiplicity (0 -1) :is-composite-p T
   ...
   (|supports| :range |BPMNProcess| :multiplicity (0 -1)
    :documentation
...
;;; ====================== BaseElement
;;; =========================================================
(def-mm-stereotype |BaseElement| (:BPMN-P) NIL (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|ActivityPartition| UML23:|Classifier| UML23:|Comment| UML23:|Dependency| UML23:|Package|) 
...
;;; ====================== BoundaryEvent
;;; =========================================================
(def-mm-stereotype |BoundaryEvent| (:BPMN-P) (|CatchEvent|) (UML23:|AcceptEventAction|) 
 ""
...
;;; ====================== BusinessRuleTask
;;; =========================================================
(def-mm-stereotype |BusinessRuleTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
...
;;; ====================== CallActivity
;;; =========================================================
(def-mm-stereotype |CallActivity| (:BPMN-P) (|BPMNActivity|) (UML23:|CallBehaviorAction|) 
...
;;; ====================== CallChoreography
;;; =========================================================
(def-mm-stereotype |CallChoreography| (:BPMN-P) (|ChoreographyActivity|) (UML23:|CallBehaviorAction|) 
...
;;; ====================== CallConversation
;;; =========================================================
(def-mm-stereotype |CallConversation| (:BPMN-P) (|ConversationNode|) (UML23:|CallBehaviorAction|) 
...
;;; ====================== CallableElement
;;; =========================================================
(def-mm-stereotype |CallableElement| (:BPMN-P) (|RootElement|) (UML23:|ActivityNode| UML23:|Classifier|) 
...
;;; ====================== CancelBoundaryEvent
;;; =========================================================
(def-mm-stereotype |CancelBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |CancelEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== CancelEndEvent
;;; =========================================================
(def-mm-stereotype |CancelEndEvent| (:BPMN-P) (|EndEvent| |CancelEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; ====================== CatchEvent
;;; =========================================================
(def-mm-stereotype |CatchEvent| (:BPMN-P) (|Event|) (UML23:|AcceptEventAction|) 
...
;;; ====================== Choreography
;;; =========================================================
(def-mm-stereotype |Choreography| (:BPMN-P) (|Collaboration|) (UML23:|Activity|) 
...
;;; =========================================================
(def-mm-stereotype |ChoreographyActivity| (:BPMN-P) (|FlowNode|) (UML23:|ActivityNode| UML23:|Classifier|) 
...
;;; ====================== ChoreographyTask
;;; =========================================================
(def-mm-stereotype |ChoreographyTask| (:BPMN-P) (|ChoreographyActivity|) (UML23:|OpaqueAction|) 
...
;;; ====================== Collaboration
;;; =========================================================
(def-mm-stereotype |Collaboration| (:BPMN-P) (|RootElement|) (UML23:|Activity|) 
...
;;; ====================== Communication
;;; =========================================================
(def-mm-stereotype |Communication| (:BPMN-P) (|ConversationNode|) (UML23:|StructuredActivityNode|) 
...
;;; =========================================================
(def-mm-stereotype |CompensationBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |CompenstationEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |CompensationEndEvent| (:BPMN-P) (|EndEvent| |CompenstationEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |CompensationStartEvent| (:BPMN-P) (|StartEvent| |CompenstationEventDefinition|) (UML23:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |CompensationThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |CompenstationEventDefinition|) (UML23:|SendObjectAction|) 
...
;;; =========================================================
(def-mm-stereotype |ComplexBehaviorDefinition| (:BPMN-P) NIL (UML23:|Class|) 
 ""
...
;;; ====================== ComplexGateway
;;; =========================================================
(def-mm-stereotype |ComplexGateway| (:BPMN-P) (|Gateway|) (UML23:|ForkNode| UML23:|JoinNode|) 
...
;;; =========================================================
(def-mm-stereotype |ConditionalBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |ConditionalEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |ConditionalCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |ConditionalEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |ConditionalStartEvent| (:BPMN-P) (|StartEvent| |ConditionalEventDefinition|) (UML23:|InitialNode|) 
 ""
...
;;; =========================================================
(def-mm-stereotype |ConversationAssociation| (:BPMN-P) (|BaseElement|) (UML23:|Class|) 
...
;;; ====================== ConversationLink
;;; =========================================================
(def-mm-stereotype |ConversationLink| (:BPMN-P) NIL (UML23:|Dependency|) 
 ""
  ())
...
;;; ====================== ConversationNode
;;; =========================================================
(def-mm-stereotype |ConversationNode| (:BPMN-P) (|InteractionNode|) (UML23:|CallBehaviorAction| UML23:|StructuredActivityNode|) 
...
;;; ====================== Correlation
;;; =========================================================
(def-mm-stereotype |Correlation| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; ====================== CorrelationKey
;;; =========================================================
(def-mm-stereotype |CorrelationKey| (:BPMN-P) (|BaseElement|) (UML23:|Class|) 
...
;;; ====================== CorrelationProperty
;;; =========================================================
(def-mm-stereotype |CorrelationProperty| (:BPMN-P) (|RootElement|) (UML23:|Class|) 
...
;;; =========================================================
(def-mm-stereotype |CorrelationPropertyBinding| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; =========================================================
(def-mm-stereotype |CorrelationPropertyRetrievalExpression| (:BPMN-P) NIL (UML23:|Class|) 
 ""
...
;;; =========================================================
(def-mm-stereotype |CorrelationSubscription| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; ====================== DataAssociation
;;; =========================================================
(def-mm-stereotype |DataAssociation| (:BPMN-P) (|BaseElement|) (UML23:|ObjectFlow|) 
...
;;; ====================== DataInput
;;; =========================================================
(def-mm-stereotype |DataInput| (:BPMN-P) (|ItemAwareElement|) (UML23:|CentralBufferNode|) 
...
;;; =========================================================
(def-mm-stereotype |DataInputAssociation| (:BPMN-P) (|DataAssociation|) (UML23:|ObjectFlow|) 
...
;;; ====================== DataObject
;;; =========================================================
(def-mm-stereotype |DataObject| (:BPMN-P) (|FlowElement| |ItemAwareElement|) (UML23:|CentralBufferNode|) 
...
;;; ====================== DataOutput
;;; =========================================================
(def-mm-stereotype |DataOutput| (:BPMN-P) (|ItemAwareElement|) (UML23:|CentralBufferNode|) 
 "A DataInput is a declaration that a particular kind of data will be used
  as input of the InputOutputSpecification. There may be multiple data inputs
  associated with an InputOutputSpecification. The DataInput is an item-aware
  element. DataInput elements may appear in a Process diagram to show the
...
;;; =========================================================
(def-mm-stereotype |DataOutputAssociation| (:BPMN-P) (|DataAssociation|) (UML23:|ObjectFlow|) 
...
;;; ====================== DataStore
;;; =========================================================
(def-mm-stereotype |DataStore| (:BPMN-P) (|ItemAwareElement| |RootElement|) (UML23:|CentralBufferNode|) 
...
;;; ====================== Definitions
;;; =========================================================
(def-mm-stereotype |Definitions| (:BPMN-P) (|BaseElement|) (UML23:|Package|) 
 ""
...
;;; ====================== EndEvent
;;; =========================================================
(def-mm-stereotype |EndEvent| (:BPMN-P) (|ThrowEvent|) (UML23:|ActivityFinalNode|) 
...
;;; ====================== EndPoint
;;; =========================================================
(def-mm-stereotype |EndPoint| (:BPMN-P) (|RootElement|) (UML23:|Class|) 
...
;;; ====================== Error
;;; =========================================================
(def-mm-stereotype |Error| (:BPMN-P) (|RootElement|) (UML23:|Class|) 
...
;;; ====================== ErrorBoundaryEvent
;;; =========================================================
(def-mm-stereotype |ErrorBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |ErrorEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== ErrorEndEvent
;;; =========================================================
(def-mm-stereotype |ErrorEndEvent| (:BPMN-P) (|EndEvent| |ErrorEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; ====================== ErrorStartEvent
;;; =========================================================
(def-mm-stereotype |ErrorStartEvent| (:BPMN-P) (|StartEvent| |ErrorEventDefinition|) (UML23:|InitialNode|) 
...
;;; ====================== Escalation
;;; =========================================================
(def-mm-stereotype |Escalation| (:BPMN-P) (|RootElement|) (UML23:|Class|) 
...
;;; =========================================================
(def-mm-stereotype |EscalationBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |EscalationEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== EscalationEndEvent
;;; =========================================================
(def-mm-stereotype |EscalationEndEvent| (:BPMN-P) (|EndEvent| |EscalationEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |EscalationStartEvent| (:BPMN-P) (|StartEvent| |EscalationEventDefinition|) (UML23:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |EscalationThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |EscalationEventDefinition|) (UML23:|SendObjectAction|) 
...
;;; ====================== Event
;;; =========================================================
(def-mm-stereotype |Event| (:BPMN-P) (|FlowNode| |MessageFlowNode| |InteractionNode|) (UML23:|Action| UML23:|ControlNode| UML23:|Event|) 
...
;;; ====================== EventBasedGateway
;;; =========================================================
(def-mm-stereotype |EventBasedGateway| (:BPMN-P) (|Gateway|) (UML23:|AcceptEventAction| UML23:|ForkNode|) 
...
;;; ====================== EventDefinition
;;; =========================================================
(def-mm-stereotype |EventDefinition| (:BPMN-P) (|RootElement|) (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|ActivityPartition| UML23:|Class| UML23:|Comment| UML23:|Dependency| UML23:|Property|) 
...
;;; ====================== ExclusiveGateway
;;; =========================================================
(def-mm-stereotype |ExclusiveGateway| (:BPMN-P) (|Gateway|) (UML23:|DecisionNode|) 
...
;;; ====================== FlowElement
;;; =========================================================
(def-mm-stereotype |FlowElement| (:BPMN-P) (|BaseElement|) (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|Classifier|) 
...
;;; ====================== FlowNode
;;; =========================================================
(def-mm-stereotype |FlowNode| (:BPMN-P) (|FlowElement|) (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|Classifier|) 
...
;;; ====================== FormalExpression
;;; =========================================================
(def-mm-stereotype |FormalExpression| (:BPMN-P) (|BPMNExpression|) (UML23:|OpaqueExpression|) 
...
;;; ====================== Gateway
;;; =========================================================
(def-mm-stereotype |Gateway| (:BPMN-P) (|FlowNode|) (UML23:|ActivityEdge| UML23:|ActivityNode|) 
...
;;; =========================================================
(def-mm-stereotype |GlobalBusinessRuleTask| (:BPMN-P) (|GlobalTask|) (UML23:|Activity|) 
 "A Business Rule Task provides a mechanism for the Process to provide input
  to a Business Rules Engine and to get the output of calculations that the
  Business Rules Engine might provide. The InputOutputSpecification of the
  Task will allow the Process to send data to and receive data from the Business
...
;;; =========================================================
(def-mm-stereotype |GlobalChoreographyTask| (:BPMN-P) (|Choreography|) (UML23:|Activity|) 
...
;;; ====================== GlobalManualTask
;;; =========================================================
(def-mm-stereotype |GlobalManualTask| (:BPMN-P) (|GlobalTask|) (UML23:|Activity|) 
...
;;; ====================== GlobalScriptTask
;;; =========================================================
(def-mm-stereotype |GlobalScriptTask| (:BPMN-P) (|GlobalTask|) (UML23:|Activity|) 
...
;;; ====================== GlobalTask
;;; =========================================================
(def-mm-stereotype |GlobalTask| (:BPMN-P) (|CallableElement|) (UML23:|Activity|) 
...
;;; ====================== GlobalUserTask
;;; =========================================================
(def-mm-stereotype |GlobalUserTask| (:BPMN-P) (|GlobalTask|) (UML23:|Activity|) 
 "A User Task is a typical workflow Task where a human performer performs
  ...
  ((|implementation| :range |UserTaskImplementation| :multiplicity (1 1)
    :documentation
     "This attribute specifies the technology that will be used to implement
      the User Task.")
   (|renderings| :range |Rendering| :multiplicity (0 -1))))


;;; =========================================================
;;; ====================== HumanPerformer
;;; =========================================================
(def-mm-stereotype |HumanPerformer| (:BPMN-P) (|Performer|) (UML23:|Actor| UML23:|Class|) 
...
;;; ====================== ImplicitThrowEvent
;;; =========================================================
(def-mm-stereotype |ImplicitThrowEvent| (:BPMN-P) (|ThrowEvent|) (UML23:|SendObjectAction|) 
 ""
  ())
...
;;; ====================== InclusiveGateway
;;; =========================================================
(def-mm-stereotype |InclusiveGateway| (:BPMN-P) (|Gateway|) (UML23:|ForkNode| UML23:|JoinNode|) 
...
;;; =========================================================
(def-mm-stereotype |InputOutputSpecification| (:BPMN-P) NIL (UML23:|Class|) 
 ""
...
;;; ====================== InputSet
;;; =========================================================
(def-mm-stereotype |InputSet| (:BPMN-P) NIL (UML23:|Class|) 
...
;;; ====================== InteractionNode
;;; =========================================================
(def-mm-stereotype |InteractionNode| (:BPMN-P) NIL (UML23:|Action| UML23:|ControlNode| UML23:|Event|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |IntermediateCatchEvent| (:BPMN-P) (|CatchEvent|) (UML23:|AcceptEventAction|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |IntermediateThrowEvent| (:BPMN-P) (|ThrowEvent|) (UML23:|SendObjectAction|) 
 ""
  ())
...
;;; ====================== ItemAwareElement
;;; =========================================================
(def-mm-stereotype |ItemAwareElement| (:BPMN-P) (|BaseElement|) (UML23:|CentralBufferNode|) 
 ""
  ())
...
;;; ====================== ItemDefinition
;;; =========================================================
(def-mm-stereotype |ItemDefinition| (:BPMN-P) (|RootElement|) (UML23:|Class|) 
 "BPMN elements, such as DataObjects and Messages, represent items that are
  ...
  ((|import| :range |BPMNImport| :multiplicity (0 1)
   ...
   (|isCollection| :range UML23:|Element| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== Lane
;;; =========================================================
(def-mm-stereotype |Lane| (:BPMN-P) (|BaseElement|) (UML23:|ActivityPartition|) 
...
;;; =========================================================
(def-mm-stereotype |LinkCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |LinkEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |LinkThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |LinkEventDefinition|) (UML23:|SendObjectAction|) 
 "The Link Intermediate Events are only valid in Normal Flow, i.e. they may
  not be used on the boundary of an Activity. A Link is a mechanism for connecting
  two sections of a Process. Link Events can be used to create looping situations
  or to avoid long Sequence Flow lines. Link Event uses are limited to a
...
;;; ====================== ManualTask
;;; =========================================================
(def-mm-stereotype |ManualTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
 "A Manual Task is a Task that is expected to be performed without the aid
  of any business process execution engine or any application. A Manual Task
  is not managed by any business process engine. It can be considered as
  an unmanaged Task, unmanaged in the sense of that the business process
...
;;; ====================== Message
;;; =========================================================
(def-mm-stereotype |Message| (:BPMN-P) (|RootElement|) (UML23:|CentralBufferNode|) 
...
;;; =========================================================
(def-mm-stereotype |MessageBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |MessageEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |MessageCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |MessageEventDefinition|) (UML23:|AcceptEventAction|) 
 ""
  ())
...
;;; ====================== MessageEndEvent
;;; =========================================================
(def-mm-stereotype |MessageEndEvent| (:BPMN-P) (|EndEvent| |MessageEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; ====================== MessageFlow
;;; =========================================================
(def-mm-stereotype |MessageFlow| (:BPMN-P) (|BaseElement|) (UML23:|Dependency|) 
...
;;; =========================================================
(def-mm-stereotype |MessageFlowAssociation| (:BPMN-P) (|BaseElement|) (UML23:|Dependency|) 
...
;;; ====================== MessageFlowNode
;;; =========================================================
(def-mm-stereotype |MessageFlowNode| (:BPMN-P) NIL (UML23:|ActivityNode| UML23:|Classifier|) 
...
;;; ====================== MessageStartEvent
;;; =========================================================
(def-mm-stereotype |MessageStartEvent| (:BPMN-P) (|StartEvent| |MessageEventDefinition|) (UML23:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |MessageThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |MessageEventDefinition|) (UML23:|SendObjectAction|) 
...
;;; ====================== Monitoring
;;; =========================================================
(def-mm-stereotype |Monitoring| (:BPMN-P) (|BaseElement|) (UML23:|Dependency|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |MultiInstanceLoopCharacteristics| (:BPMN-P) NIL (UML23:|CallBehaviorAction| UML23:|OpaqueAction| UML23:|StructuredActivityNode|) 
...
;;; =========================================================
(def-mm-stereotype |MultipleBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |TimerEventDefinition| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TerminateEventDefinition| |CancelEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== MultipleStartEvent
;;; =========================================================
(def-mm-stereotype |MultipleStartEvent| (:BPMN-P) (|StartEvent| |CancelEventDefinition| |MessageEventDefinition| |LinkEventDefinition| |TimerEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TerminateEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition|) (UML23:|InitialNode|) 
...
;;; ====================== NoneEndEvent
;;; =========================================================
(def-mm-stereotype |NoneEndEvent| (:BPMN-P) (|EndEvent|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |NoneIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent|) (UML23:|AcceptEventAction|) 
...
;;; ====================== NoneStartEvent
;;; =========================================================
(def-mm-stereotype |NoneStartEvent| (:BPMN-P) (|StartEvent|) (UML23:|InitialNode|) 
...
;;; ====================== Operation
;;; =========================================================
(def-mm-stereotype |Operation| (:BPMN-P) (|BaseElement|) (UML23:|Operation|) 
 ""
  ((|errorRef| :range |Error| :multiplicity (0 -1)
    :documentation
...
;;; ====================== OutputSet
;;; =========================================================
(def-mm-stereotype |OutputSet| (:BPMN-P) NIL (UML23:|Class|) 
 ""
...
;;; ====================== ParallelGateway
;;; =========================================================
(def-mm-stereotype |ParallelGateway| (:BPMN-P) (|Gateway|) (UML23:|ForkNode| UML23:|JoinNode|) 
...
;;; =========================================================
(def-mm-stereotype |ParallelMultipleCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TimerEventDefinition| |CancelEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition| |TerminateEventDefinition|) (UML23:|AcceptEventAction|) 
 "This means that there are multiple triggers assigned to the Event. If used
...
;;; ====================== Participant
;;; =========================================================
(def-mm-stereotype |Participant| (:BPMN-P) (|MessageFlowNode| |RootElement| |BaseElement|) (UML23:|Actor| UML23:|Class|) 
 "A Participant represents a specific PartnerEntity (e.g., a company) and/or
  ...
  ((|endpointRefs| :range |EndPoint| :multiplicity (0 -1)
   ...
   (|interfaceRef| :range UML23:|Interface| :multiplicity (:* -1)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ParticipantAssociation| (:BPMN-P) (|BaseElement|) (UML23:|Dependency|) 
...
;;; ====================== PartnerEntity
;;; =========================================================
(def-mm-stereotype |PartnerEntity| (:BPMN-P) (|RootElement|) (UML23:|Actor| UML23:|Class|) 
...
;;; ====================== PartnerRole
;;; =========================================================
(def-mm-stereotype |PartnerRole| (:BPMN-P) (|RootElement|) (UML23:|Actor| UML23:|Class|) 
...
;;; ====================== Performer
;;; =========================================================
(def-mm-stereotype |Performer| (:BPMN-P) (|ResourceRole|) (UML23:|Actor| UML23:|Class|) 
...
;;; ====================== PinProperty
;;; =========================================================
(def-mm-stereotype |PinProperty| (:BPMN-P) (|BPMNProperty|) (UML23:|ValuePin|) 
 ""
  ())
...
;;; ====================== Pool
;;; =========================================================
(def-mm-stereotype |Pool| (:BPMN-P) (|MessageFlowNode|) (UML23:|ActivityPartition|) 
...
;;; ====================== PotentialOwner
;;; =========================================================
(def-mm-stereotype |PotentialOwner| (:BPMN-P) (|HumanPerformer|) (UML23:|Actor| UML23:|Class|) 
 ""
  ())
...
;;; ====================== ReceiveTask
;;; =========================================================
(def-mm-stereotype |ReceiveTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
 "A Receive Task is a simple Task that is designed to wait for a Message
  ...
  ((|implementation| :range |Implementation| :multiplicity (1 1) :default :|web service|
   ...
   (|instantiate| :range UML23:|Element| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== Relationship
;;; =========================================================
(def-mm-stereotype |Relationship| (:BPMN-P) (|BaseElement|) (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|Classifier| UML23:|Dependency|) 
...
;;; ====================== Rendering
;;; =========================================================
(def-mm-stereotype |Rendering| (:BPMN-P) NIL (UML23:|Pin|) 
...
;;; ====================== Resource
;;; =========================================================
(def-mm-stereotype |Resource| (:BPMN-P) (|RootElement|) (UML23:|Actor| UML23:|Class|) 
...
;;; =========================================================
(def-mm-stereotype |ResourceAssignmentExpression| (:BPMN-P) NIL (UML23:|Class|) 
 ""
...
;;; ====================== ResourceParameter
;;; =========================================================
(def-mm-stereotype |ResourceParameter| (:BPMN-P) (|RootElement| |BaseElement|) (UML23:|Property|) 
...
;;; =========================================================
(def-mm-stereotype |ResourceParameterBinding| (:BPMN-P) NIL (UML23:|Class|) 
 ""
  ((|expression| :range |String| :multiplicity (1 1) :is-composite-p T
    :documentation
...
;;; ====================== ResourceRole
;;; =========================================================
(def-mm-stereotype |ResourceRole| (:BPMN-P) (|BaseElement|) (UML23:|Actor| UML23:|Class|) 
 "The ResourceRole element inherits the attributes and model associations
  ...
  ((|ResourceAssignmentExpression| :range |ResourceAssignmentExpression| :multiplicity (0 1) :is-composite-p T
   ...
   (|resourceParameterBindings| :range |ResourceParameterBinding| :multiplicity (:* -1) :is-composite-p T
    :documentation
...
;;; ====================== RootElement
;;; =========================================================
(def-mm-stereotype |RootElement| (:BPMN-P) (|BaseElement|) (UML23:|ActivityEdge| UML23:|ActivityNode| UML23:|ActivityPartition| UML23:|Classifier| UML23:|Comment| UML23:|Dependency| UML23:|Property|) 
...
;;; ====================== ScriptTask
;;; =========================================================
(def-mm-stereotype |ScriptTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
 "A Script Task is executed by a business process engine. The modeler or
  implementer defines a script in a language that the engine can interpret.
  When the Task is ready to start, the engine will execute the script. When
  the script is completed, the Task will also be completed."
...
;;; ====================== SendTask
;;; =========================================================
(def-mm-stereotype |SendTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
...
;;; ====================== SequenceFlow
;;; =========================================================
(def-mm-stereotype |SequenceFlow| (:BPMN-P) (|FlowElement|) (UML23:|ControlFlow|) 
...
;;; ====================== ServiceTask
;;; =========================================================
(def-mm-stereotype |ServiceTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
...
;;; ====================== SignalBoundaryEvent
;;; =========================================================
(def-mm-stereotype |SignalBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |SignalEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |SignalCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |SignalEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== SignalEndEvent
;;; =========================================================
(def-mm-stereotype |SignalEndEvent| (:BPMN-P) (|EndEvent| |SignalEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; ====================== SignalStartEvent
;;; =========================================================
(def-mm-stereotype |SignalStartEvent| (:BPMN-P) (|StartEvent| |SignalEventDefinition|) (UML23:|InitialNode|) 
 ""
...
;;; =========================================================
(def-mm-stereotype |SignalThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |SignalEventDefinition|) (UML23:|Class| UML23:|SendObjectAction|) 
 "This type of event is used for sending or receiving Signals. A Signal is
  for general communication within and across Process Levels, across Pools,
  and between Business Process Diagrams. A BPMN Signal is similar to a signal
  flare that shot into the sky for anyone who might be interested to notice
...
;;; =========================================================
(def-mm-stereotype |StandardLoopCharacteristics| (:BPMN-P) NIL (UML23:|CallBehaviorAction| UML23:|OpaqueAction| UML23:|StructuredActivityNode|) 
...
;;; ====================== StartEvent
;;; =========================================================
(def-mm-stereotype |StartEvent| (:BPMN-P) (|CatchEvent|) (UML23:|InitialNode|) 
...
;;; ====================== SubChoreography
;;; =========================================================
(def-mm-stereotype |SubChoreography| (:BPMN-P) (|ChoreographyActivity|) (UML23:|StructuredActivityNode|) 
 "A Choreography Sub-Process is a compound Activity in that it has detail
  ...
  a Choreography Task."
  ((|referencedDiagram| :range UML23:|Element| :multiplicity (1 1))))


;;; =========================================================
;;; ====================== SubConversation
;;; =========================================================
(def-mm-stereotype |SubConversation| (:BPMN-P) (|ConversationNode|) (UML23:|StructuredActivityNode|) 
...
;;; ====================== SubProcess
;;; =========================================================
(def-mm-stereotype |SubProcess| (:BPMN-P) (|BPMNActivity|) (UML23:|StructuredActivityNode|) 
 "A Sub-Process is an Activity whose internal details have been modeled using
  ...
  ((|referencedDiagram| :range UML23:|Element| :multiplicity (0 1))
...
;;; ====================== Task
;;; =========================================================
(def-mm-stereotype |Task| (:BPMN-P) (|BPMNActivity| |MessageFlowNode| |InteractionNode|) (UML23:|OpaqueAction|) 
...
;;; ====================== TerminateEndEvent
;;; =========================================================
(def-mm-stereotype |TerminateEndEvent| (:BPMN-P) (|EndEvent| |TerminateEventDefinition|) (UML23:|ActivityFinalNode|) 
 ""
  ())
...
;;; ====================== TextAnnotation
;;; =========================================================
(def-mm-stereotype |TextAnnotation| (:BPMN-P) (|BPMNArtifact|) (UML23:|Comment|) 
...
;;; ====================== TimerBoundaryEvent
;;; =========================================================
(def-mm-stereotype |TimerBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |TimerEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |TimerCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |TimerEventDefinition|) (UML23:|AcceptEventAction|) 
...
;;; ====================== TimerStartEvent
;;; =========================================================
(def-mm-stereotype |TimerStartEvent| (:BPMN-P) (|StartEvent| |TimerEventDefinition|) (UML23:|InitialNode|) 
 "A specific time-date or a specific cycle (e.g. every Monday at 9 am) can
...
;;; ====================== Transaction
;;; =========================================================
(def-mm-stereotype |Transaction| (:BPMN-P) (|SubProcess|) (UML23:|StructuredActivityNode|) 
...
;;; ====================== UserTask
;;; =========================================================
(def-mm-stereotype |UserTask| (:BPMN-P) (|Task|) (UML23:|OpaqueAction|) 
 "A User Task is a typical workflow Task where a human performer performs
  the Task with the assistance of a software application and is scheduled
...
;;; ====================== VariableProperty
;;; =========================================================
(def-mm-stereotype |VariableProperty| (:BPMN-P) (|BPMNProperty|) (UML23:|Class| UML23:|Variable|) 
 ""
  ())
...
;;; ====================== conditional_false
;;; =========================================================
(def-mm-stereotype |conditional_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== conditional_true
;;; =========================================================
(def-mm-stereotype |conditional_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== escalation_false
;;; =========================================================
(def-mm-stereotype |escalation_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== escalation_true
;;; =========================================================
(def-mm-stereotype |escalation_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== is_collection_false
;;; =========================================================
(def-mm-stereotype |is_collection_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== is_collection_true
;;; =========================================================
(def-mm-stereotype |is_collection_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== message_false
;;; =========================================================
(def-mm-stereotype |message_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== message_true
;;; =========================================================
(def-mm-stereotype |message_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== multiple_false
;;; =========================================================
(def-mm-stereotype |multiple_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== multiple_true
;;; =========================================================
(def-mm-stereotype |multiple_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |parrallelMultiple_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |parrallelMultiple_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== signal_false
;;; =========================================================
(def-mm-stereotype |signal_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== signal_true
;;; =========================================================
(def-mm-stereotype |signal_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_conditional_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_conditional_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_escalation_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_escalation_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_message_false
;;; =========================================================
(def-mm-stereotype |start_message_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_message_true
;;; =========================================================
(def-mm-stereotype |start_message_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_multiple_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_multiple_true
;;; =========================================================
(def-mm-stereotype |start_multiple_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_parallelMultiple_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_parallelMultiple_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_signal_false
;;; =========================================================
(def-mm-stereotype |start_signal_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_signal_true
;;; =========================================================
(def-mm-stereotype |start_signal_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_timer_false
;;; =========================================================
(def-mm-stereotype |start_timer_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_timer_true
;;; =========================================================
(def-mm-stereotype |start_timer_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== timer_false
;;; =========================================================
(def-mm-stereotype |timer_false| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== timer_true
;;; =========================================================
(def-mm-stereotype |timer_true| (:BPMN-P) NIL (UML23:|EnumerationLiteral|) 
 ""
  ())
