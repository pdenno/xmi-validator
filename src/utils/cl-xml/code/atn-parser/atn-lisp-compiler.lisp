  ...
  (let* ((net-name (atn-name node))
    ...
    (setf form
          `(,net-name (index &aux
                      ...
                      (declare (optimize (speed #+CMU 1 #-CMU ,(if *atn-trace* 1 3)) (safety #+CMU 3 #-CMU ,(if *atn-trace* 3 0))))
                            ...
                            (%atn-block ,net-name
                              (labels ((succeed (index result)
                                ...
                                ,@(unless *atn-ambiguous
                                    `((declare (inline succeed fail #|pod#-(and LispWorks (not lispworks4.3))|#,@(mapcar #'first functions)))))
