...
;;; POD this is used by xmlu-utils::canonical-encoding
(defParameter *encoding-map*
  '((:UTF-8 :UTF8)
    ...
    ; 2012-03-07
    (:SHIFT_JIS :SHIFTJIS :WINDOWSCP936 :JIS :EUCJP :GBK) ; pod added :windows-cp936, etc. just guessing it might work.
    ;; pod 2008-06-18 adding windows1252 (and #\- really does get removed!)
    (:ISO-8859-1 :ISO88591 :WINDOWS1252)) 
  "specify alternative encoding names.
   in particular, support punctuation variations.")

;(mapcar #'xml-utils::canonical-encoding '(:utf-8 "usascii" "shift-jis" "windows-cp936"))
